...
- **MLOps for the edge**: versioned datasets+models, shadow/canary deploys,
  drift monitoring. See [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md).
...
*Repo references (`onboard/`, `navigation/`, `policy/`, `sitl.md` → now [22-autonomy-px4-sitl.md](22-autonomy-px4-sitl.md)) point to the author's `pixhawk/drone/` project. Standards evolve — verify against primary sources.*
