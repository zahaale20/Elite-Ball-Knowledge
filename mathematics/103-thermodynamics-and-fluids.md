...
This module supplies the energy and flow physics behind the vehicles modeled in [102-foundations-physics-for-engineers.md](102-physics-for-engineers.md) and controlled in [101-foundations-control-advanced.md](101-control-advanced.md). Endurance and propulsion tradeoffs feed mission planning in [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md) and the systems budgets of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md). The calculus and differential-equation tools come from [03-foundations-mathematics.md](../foundations/03-mathematics.md); the field analogies (flux, divergence) recur in [104-foundations-electromagnetics.md](104-electromagnetics.md).
...
A small drone and a jet are *different physics regimes* because they sit at different $Re$ — a scaling insight from [102-foundations-physics-for-engineers.md](102-physics-for-engineers.md).
