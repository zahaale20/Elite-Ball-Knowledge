...
feeds it lives in [02-foundations-probability-and-stochastic.md](02-probability-and-stochastic.md);
...
[04-foundations-numerical-methods.md](04-numerical-methods.md). Downstream
it powers the estimators and controllers of [09-autonomy-gnc.md](../autonomy/09-gnc.md)
and [06-autonomy-control-theory.md](../autonomy/06-control-theory.md), the learning of
[01-autonomy-ml-ai.md](../autonomy/01-ml-ai.md), and the planners of
[10-autonomy-planning-decision.md](../autonomy/10-planning-decision.md). It also rests on
...
commands on your VTOL — see [06-autonomy-control-theory.md](../autonomy/06-control-theory.md).
...
Trajectory optimization in [10-autonomy-planning-decision.md](../autonomy/10-planning-decision.md)
lives here.
