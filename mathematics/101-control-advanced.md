...
This module is the rigorous continuation of [25-autonomy-control-theory.md](../autonomy/25-control-theory.md) and feeds directly into guidance and navigation in [28-autonomy-gnc.md](../autonomy/28-gnc.md) and decision-making in [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md). The linear-algebra and calculus machinery comes from [03-foundations-mathematics.md](../foundations/03-mathematics.md); the systems-engineering framing of *requirements as constraints* comes from [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md). For the physics of the plants we control, see [102-foundations-physics-for-engineers.md](102-physics-for-engineers.md); for the estimation theory dual to optimal control, see [53-autonomy-state-estimation-advanced.md](../autonomy/53-state-estimation-advanced.md). Decision-theoretic adversaries appear in [105-foundations-decision-and-game-theory.md](105-decision-and-game-theory.md).
...
Compare to CARE: $A \leftrightarrow A^\top$, $B \leftrightarrow C^\top$, $Q \leftrightarrow W$, $R \leftrightarrow V$. **Control and estimation are mathematical duals.** This is why mastering one halves the work of learning the other (see [53-autonomy-state-estimation-advanced.md](../autonomy/53-state-estimation-advanced.md)).
...
This cascade mirrors the systems-engineering principle of separating timescales (see [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md)). The outer loops set references; the inner loops enforce them with certified stability. The guidance layer connects to [28-autonomy-gnc.md](../autonomy/28-gnc.md), and the adversarial mission layer to [105-foundations-decision-and-game-theory.md](105-decision-and-game-theory.md) and [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md).
