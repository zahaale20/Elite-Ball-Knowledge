...
This module is the rigorous continuation of [06-autonomy-control-theory.md](../autonomy/06-control-theory.md) and feeds directly into guidance and navigation in [09-autonomy-gnc.md](../autonomy/09-gnc.md) and decision-making in [10-autonomy-planning-decision.md](../autonomy/10-planning-decision.md). The linear-algebra and calculus machinery comes from [03-foundations-mathematics.md](../foundations/03-mathematics.md); the systems-engineering framing of *requirements as constraints* comes from [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md). For the physics of the plants we control, see [08-foundations-physics-for-engineers.md](08-physics-for-engineers.md); for the estimation theory dual to optimal control, see [14-autonomy-state-estimation-advanced.md](../autonomy/14-state-estimation-advanced.md). Decision-theoretic adversaries appear in [11-foundations-decision-and-game-theory.md](11-decision-and-game-theory.md).
...
Compare to CARE: $A \leftrightarrow A^\top$, $B \leftrightarrow C^\top$, $Q \leftrightarrow W$, $R \leftrightarrow V$. **Control and estimation are mathematical duals.** This is why mastering one halves the work of learning the other (see [14-autonomy-state-estimation-advanced.md](../autonomy/14-state-estimation-advanced.md)).
