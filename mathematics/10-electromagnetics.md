...
This module underpins the RF and sensing physics of [03-rf-and-comms-systems.md](../engineering/03-rf-and-comms-systems.md), the GNSS jamming/spoofing analysis in [07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md), and counter-UAS electronic warfare in [08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md). The vector calculus (divergence, curl, Laplacian) is developed in [03-foundations-mathematics.md](../foundations/03-mathematics.md); the wave/oscillation mathematics parallels [08-foundations-physics-for-engineers.md](08-physics-for-engineers.md); the flux/divergence intuition mirrors fluid continuity in [09-foundations-thermodynamics-and-fluids.md](09-thermodynamics-and-fluids.md). Sensor implications feed [11-autonomy-perception-deep.md](../autonomy/11-perception-deep.md).
...
Polarization is a free design axis for both communication robustness and electronic attack (see [08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md)).
...
Every datalink, GPS signal, and radar return obeys Friis. The link closes only if $P_r$ exceeds receiver sensitivity (noise floor + required SNR). A jammer's goal is simply to raise that noise floor — directly the analysis of [07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md).
...
Each effect is a boundary-value problem on Maxwell's equations, and each shapes where, when, and how a link or radar works. The frequency-dependence of these effects is *why spectrum allocation is strategy*, not just regulation — see [03-rf-and-comms-systems.md](../engineering/03-rf-and-comms-systems.md).
