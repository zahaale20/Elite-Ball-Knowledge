...
solvers it stabilizes power [95-foundations-optimization.md](95-optimization.md);
the factorizations it implements come from
[97-foundations-linear-algebra-applied.md](97-linear-algebra-applied.md); the
...
[25-autonomy-control-theory.md](../autonomy/25-control-theory.md) and the prediction step in
[28-autonomy-gnc.md](../autonomy/28-gnc.md); it underpins the training loops of
[20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md) and extends
...
[20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md). The **complex-step trick**,
