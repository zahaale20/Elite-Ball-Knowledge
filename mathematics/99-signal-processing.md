...
[97-foundations-linear-algebra-applied.md](97-linear-algebra-applied.md) and
[03-foundations-mathematics.md](../foundations/03-mathematics.md); the noise it suppresses is
characterized in
[96-foundations-probability-and-stochastic.md](96-probability-and-stochastic.md);
the filters it designs are optimized using
[95-foundations-optimization.md](95-optimization.md) and run with the numerics of
[98-foundations-numerical-methods.md](98-numerical-methods.md). Its outputs feed
the estimators of [28-autonomy-gnc.md](../autonomy/28-gnc.md), the controllers of
[25-autonomy-control-theory.md](../autonomy/25-control-theory.md), and the perception of
[20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md). Its channel-capacity cousin is
[100-foundations-information-theory.md](100-information-theory.md).
...
[25-autonomy-control-theory.md](../autonomy/25-control-theory.md); the bilinear transform maps one
