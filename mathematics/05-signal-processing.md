...
[03-foundations-linear-algebra-applied.md](03-linear-algebra-applied.md) and
...
[01-foundations-optimization.md](01-optimization.md) and run with the numerics of
[04-foundations-numerical-methods.md](04-numerical-methods.md). Its outputs feed
the estimators of [09-autonomy-gnc.md](../autonomy/09-gnc.md), the controllers of
[06-autonomy-control-theory.md](../autonomy/06-control-theory.md), and the perception of
[01-autonomy-ml-ai.md](../autonomy/01-ml-ai.md). Its channel-capacity cousin is
...
[06-autonomy-control-theory.md](../autonomy/06-control-theory.md); the bilinear transform maps one
