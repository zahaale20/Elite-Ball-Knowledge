...
This module underpins the RF and sensing physics of [67-rf-and-comms-systems.md](../engineering/67-rf-and-comms-systems.md), the GNSS jamming/spoofing analysis in [26-autonomy-gnss-jamming-spoofing.md](../autonomy/26-gnss-jamming-spoofing.md), and counter-UAS electronic warfare in [27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md). The vector calculus (divergence, curl, Laplacian) is developed in [03-foundations-mathematics.md](../foundations/03-mathematics.md); the wave/oscillation mathematics parallels [102-foundations-physics-for-engineers.md](102-physics-for-engineers.md); the flux/divergence intuition mirrors fluid continuity in [103-foundations-thermodynamics-and-fluids.md](103-thermodynamics-and-fluids.md). Sensor implications feed [50-autonomy-perception-deep.md](../autonomy/50-perception-deep.md).
...
Polarization is a free design axis for both communication robustness and electronic attack (see [27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md)).
...
Every datalink, GPS signal, and radar return obeys Friis. The link closes only if $P_r$ exceeds receiver sensitivity (noise floor + required SNR). A jammer's goal is simply to raise that noise floor — directly the analysis of [26-autonomy-gnss-jamming-spoofing.md](../autonomy/26-gnss-jamming-spoofing.md).
...
Each effect is a boundary-value problem on Maxwell's equations, and each shapes where, when, and how a link or radar works. The frequency-dependence of these effects is *why spectrum allocation is strategy*, not just regulation — see [67-rf-and-comms-systems.md](../engineering/67-rf-and-comms-systems.md).
