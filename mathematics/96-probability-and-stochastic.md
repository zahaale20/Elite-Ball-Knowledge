...
likelihood into an estimate is in [95-foundations-optimization.md](95-optimization.md);
...
[98-foundations-numerical-methods.md](98-numerical-methods.md). Downstream it
is the language of the estimators in [28-autonomy-gnc.md](../autonomy/28-gnc.md), the learning
in [20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md), the decision-making in
[29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md), and it sits beside the
...
(§4 of [95-foundations-optimization.md](95-optimization.md)); the probabilistic
