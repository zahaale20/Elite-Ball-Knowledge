...
feeds it lives in [96-foundations-probability-and-stochastic.md](96-probability-and-stochastic.md);
the matrix factorizations that solve its linear algebra core live in
[97-foundations-linear-algebra-applied.md](97-linear-algebra-applied.md);
the numerical care that keeps it from exploding lives in
[98-foundations-numerical-methods.md](98-numerical-methods.md). Downstream
it powers the estimators and controllers of [28-autonomy-gnc.md](../autonomy/28-gnc.md)
and [25-autonomy-control-theory.md](../autonomy/25-control-theory.md), the learning of
[20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md), and the planners of
[29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md). It also rests on
the general math foundation in [03-foundations-mathematics.md](../foundations/03-mathematics.md).
...
[96-foundations-probability-and-stochastic.md](96-probability-and-stochastic.md)).
...
commands on your VTOL — see [25-autonomy-control-theory.md](../autonomy/25-control-theory.md).
...
Trajectory optimization in [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md)
lives here.
...
[20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md).
