...
This module provides the computational backbone for the planning algorithms of [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md), the equilibrium computations of [105-foundations-decision-and-game-theory.md](105-decision-and-game-theory.md), and the optimization solvers behind [101-foundations-control-advanced.md](101-control-advanced.md) (MPC is a QP solved every timestep). The discrete-math and proof foundations come from [03-foundations-mathematics.md](../foundations/03-mathematics.md); the perception consumers appear in [50-autonomy-perception-deep.md](../autonomy/50-perception-deep.md) and [51-autonomy-slam-and-mapping.md](../autonomy/51-slam-and-mapping.md). The engineering-tradeoff mindset is the algorithmic face of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md).
...
This is the workhorse of grid and lattice planning in [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md). The Euclidean distance is the canonical admissible heuristic for spatial planning.
