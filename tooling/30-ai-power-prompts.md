...
([02-ten-year-mastery-plan.md](../foundations/02-ten-year-mastery-plan.md)) has one
...
```
*(See [26-autonomy-gnss-jamming-spoofing.md](../autonomy/26-gnss-jamming-spoofing.md).)*
...
[02-ten-year-mastery-plan.md](../foundations/02-ten-year-mastery-plan.md): the AI accelerates the
...
```
*(See [27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md).)*
...
- [02-ten-year-mastery-plan.md](../foundations/02-ten-year-mastery-plan.md) — the principle this file serves: AI accelerates, never replaces, understanding.
- [22-autonomy-px4-sitl.md](../autonomy/22-px4-sitl.md) / [23-autonomy-onboard-system.md](../autonomy/23-onboard-system.md) — the stack the domain prompts target.
- [24-autonomy-test-scaffold.md](../autonomy/24-test-scaffold.md) — turning the AI's tests into a real harness.
- [25-autonomy-control-theory.md](../autonomy/25-control-theory.md) / [28-autonomy-gnc.md](../autonomy/28-gnc.md) — the fundamentals you must own, not outsource.
- [12-career-software-engineering.md](../career/12-software-engineering.md) / [17-career-interview-prep.md](../career/17-interview-prep.md) — where "can you explain what you built?" gets tested.
