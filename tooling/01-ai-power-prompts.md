...
```
*(See [07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md).)*
...
```
*(See [08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md).)*
...
- [03-autonomy-px4-sitl.md](../autonomy/03-px4-sitl.md) / [04-autonomy-onboard-system.md](../autonomy/04-onboard-system.md) — the stack the domain prompts target.
- [05-autonomy-test-scaffold.md](../autonomy/05-test-scaffold.md) — turning the AI's tests into a real harness.
- [06-autonomy-control-theory.md](../autonomy/06-control-theory.md) / [09-autonomy-gnc.md](../autonomy/09-gnc.md) — the fundamentals you must own, not outsource.
- [03-career-software-engineering.md](../career/03-software-engineering.md) / [08-career-interview-prep.md](../career/08-interview-prep.md) — where "can you explain what you built?" gets tested.
