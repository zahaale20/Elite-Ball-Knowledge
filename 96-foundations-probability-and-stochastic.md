...
likelihood into an estimate is in [95-foundations-optimization.md](95-foundations-optimization.md);
...
[98-foundations-numerical-methods.md](98-foundations-numerical-methods.md). Downstream it
is the language of the estimators in [28-autonomy-gnc.md](28-autonomy-gnc.md), the learning
in [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md), the decision-making in
[29-autonomy-planning-decision.md](29-autonomy-planning-decision.md), and it sits beside the
general math foundation in [03-foundations-mathematics.md](03-foundations-mathematics.md).
...
(§4 of [95-foundations-optimization.md](95-foundations-optimization.md)); the probabilistic
