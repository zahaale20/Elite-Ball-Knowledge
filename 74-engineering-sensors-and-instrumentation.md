...
[52-autonomy-sensor-fusion.md](52-autonomy-sensor-fusion.md) and the state estimators of
...
The probability and statistics are from [03-foundations-mathematics.md](03-foundations-mathematics.md);
the first-principles error budget from [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md).
Signal conditioning lives on the board of [78-engineering-pcb-and-electronics-design.md](78-engineering-pcb-and-electronics-design.md);
...
core argument of [52-autonomy-sensor-fusion.md](52-autonomy-sensor-fusion.md).
...
[26-autonomy-gnss-jamming-spoofing.md](26-autonomy-gnss-jamming-spoofing.md). GNSS is
...
| Encoder (optical) | codewheel | angle (see §6 of [73](73-engineering-mechatronics-and-actuation.md)) | dust |
...
fuses modalities ([50-autonomy-perception-deep.md](50-autonomy-perception-deep.md),
[52-autonomy-sensor-fusion.md](52-autonomy-sensor-fusion.md)).
...
loop costs phase margin (see [25-autonomy-control-theory.md](25-autonomy-control-theory.md)).
...
- **Online estimation:** carry sensor biases as states in the EKF
  ([52-autonomy-sensor-fusion.md](52-autonomy-sensor-fusion.md)) so they are tracked in
