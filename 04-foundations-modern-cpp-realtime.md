...
[12-career-software-engineering.md](12-career-software-engineering.md) (the engineering craft
around the code), [25-autonomy-control-theory.md](25-autonomy-control-theory.md) and
[28-autonomy-gnc.md](28-autonomy-gnc.md) (the loops that demand real-time), and
...
> game, and it's a [systems-engineering](01_first_principles_systems_engineering.md) call.
...
- **Strong types over raw primitives.** A bare `float yaw` invites the NED/ENU frame bug from
  [Module 03](03-foundations-mathematics.md). A `struct YawNED { float rad; };` makes the
...
the math of [Module 03](03-foundations-mathematics.md) — gives you matrix expressions that
...
> [Module 06 (sim/test/verification)](06-foundations-simulation-test-verification.md) and
> your [testing instincts](12-career-software-engineering.md) demand, and it ties directly to
> the safety case in [Module 09](09-foundations-safety-assurance.md).
...
boundary, and it ties straight to the [systems-engineering](01_first_principles_systems_engineering.md)
...
| **Latency** | input-to-output delay | adds phase lag → erodes control stability margin ([Module 25](25-autonomy-control-theory.md)) |
...
[systems-engineering tradeoff](01_first_principles_systems_engineering.md), made on the basis
of deadlines.
...
[Module 03 §3.4](03-foundations-mathematics.md) over every detection against every track,
...
1. **Correctness first.** Golden-test the C++ output against the Python original on recorded
   ...
   [verification module](06-foundations-simulation-test-verification.md) demands of any
   rewrite.)
