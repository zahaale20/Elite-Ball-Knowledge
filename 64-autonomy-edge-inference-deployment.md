...
Edge deployment is the final, mandatory stage for every learned component in this curriculum: the vision of [59-autonomy-computer-vision.md](59-autonomy-computer-vision.md), the point-cloud nets of [60-autonomy-lidar-radar-processing.md](60-autonomy-lidar-radar-processing.md), the VIO of [61-autonomy-visual-inertial-odometry.md](61-autonomy-visual-inertial-odometry.md), and the foundation models of [63-autonomy-foundation-models-robotics.md](63-autonomy-foundation-models-robotics.md) all bottleneck here. It realizes the training of [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md) on real silicon, enforces the real-time guarantees the control loops of [28-autonomy-gnc.md](28-autonomy-gnc.md) and planners of [29-autonomy-planning-decision.md](29-autonomy-planning-decision.md) depend on, lives inside the onboard architecture of [23-autonomy-onboard-system.md](23-autonomy-onboard-system.md), and rests on the numerical foundations of [03-foundations-mathematics.md](03-foundations-mathematics.md) and the real-time systems craft of [04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md).
...
- Garbage collection / Python in the loop (use C++/compiled runtimes for the real-time path — see [04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md)).
...
| **Integration** | Closed-loop stability with real latency | Hardware-in-the-loop, sim ([62-autonomy-sim-to-real.md](62-autonomy-sim-to-real.md)) |
...
- **Integration:** **ROS 2** with C++ real-time nodes ([04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md)), `isaac_ros` GEMs for accelerated perception.
