...
> [69-engineering-propulsion-and-electric-propulsion.md](../engineering/69-propulsion-and-electric-propulsion.md)
...
Space is orbital mechanics ([95-optimization](../mathematics/95-optimization.md)
and the dynamics of [03-mathematics](../foundations/03-mathematics.md) made
celestial), plus the comms of
[67-rf-and-comms-systems](../engineering/67-rf-and-comms-systems.md), the power
and thermal of [68](../engineering/68-power-electronics.md)/[72](../engineering/72-thermal-management.md),
and the GNC of [28-gnc](../autonomy/28-gnc.md) applied where there is no air and
no ground.
...
(see [69-propulsion](../engineering/69-propulsion-and-electric-propulsion.md)).
...
- **Rendezvous & proximity operations (RPO)** — matching another object's orbit —
  ...
  estimation in [53-state-estimation-advanced](../autonomy/53-state-estimation-advanced.md).
...
- **The economic revolution:** when launch cost collapses (reusability, §7) and
  ...
  [38-spacex-rapid-iteration](../companies/38-spacex-rapid-iteration.md) and
  [41-tesla-vertical-integration](../companies/41-tesla-vertical-integration-data.md)
...
- **Structure & mechanisms** — survive launch loads (the most violent part of the
  ...
  [71-structures-and-materials](../engineering/71-structures-and-materials.md).
- **Power** — solar arrays + batteries sized for the worst-case **eclipse**
  ...
  see [68-power-electronics](../engineering/68-power-electronics.md) and
  [79-batteries](../engineering/79-batteries-and-energy-storage.md).
...
- **ADCS (Attitude Determination & Control)** — point the payload. Sensors (star
  ...
  [28-gnc](../autonomy/28-gnc.md) estimation/control loop in three rotational
...
- **C&DH (Command & Data Handling)** — the rad-hardened flight computer. Space
  ...
  [77-reliability](../engineering/77-reliability-and-failure-analysis.md) under
  a particle flux.
...
- **Launch** is the $\Delta v \approx 9.4$ km/s climb out of the gravity well
  ...
  [69-propulsion §2](../engineering/69-propulsion-and-electric-propulsion.md)).
...
- **Reentry** is the reverse problem: you have ~7.8 km/s of kinetic energy to get
  ...
  [132-missiles-guided-munitions-hypersonics](../autonomy/132-missiles-guided-munitions-hypersonics.md).
...
link budget is the unforgiving accounting of [67-rf-and-comms](../engineering/67-rf-and-comms-systems.md)
...
- **Better coding** (LDPC, turbo) buys you margin in dB for free, the
  [100-information-theory](../mathematics/100-information-theory.md) channel-coding
...
is the orbital extension of [27-counter-uas-ew](../autonomy/27-counter-uas-ew.md)
and [26-gnss](../autonomy/26-gnss-jamming-spoofing.md).
...
- **Space Domain Awareness (SDA)** is the orbital sensor-fusion and tracking
  ...
  It is [52-sensor-fusion](../autonomy/52-sensor-fusion.md) and
  [60-lidar-radar](../autonomy/60-lidar-radar-processing.md) at planetary scale.
- **Resilience by architecture:** the strategic answer to fragile, exquisite
  ...
  [121-new-defense-tech-cohort](../companies/121-new-defense-tech-cohort.md).
...
- **Earth observation** turned into a data business — daily global imaging feeding
  the [40-palantir-forward-deployed](../companies/40-palantir-forward-deployed.md)
  and [20-ml-ai](../autonomy/20-ml-ai.md) analysis stacks.
...
- **Defense space** (SDA, missile warning/tracking, responsive launch) is one of
  ...
  [11-defense-aerospace-playbook](../career/11-defense-aerospace-playbook.md).
...
5. **Threat reasoning.** For a drone mission that depends on GPS + Starlink, list
   ...
   each. Map it back to [26](../autonomy/26-gnss-jamming-spoofing.md) and
   [27](../autonomy/27-counter-uas-ew.md).
...
- **Up the stack:** propulsion physics
  ([69](../engineering/69-propulsion-and-electric-propulsion.md)), GNC/estimation
  ([28](../autonomy/28-gnc.md)), RF/comms
  ([67](../engineering/67-rf-and-comms-systems.md)).
- **Across:** GNSS denial ([26](../autonomy/26-gnss-jamming-spoofing.md)),
  counter-UAS/EW ([27](../autonomy/27-counter-uas-ew.md)), hypersonics & reentry
  ([132](../autonomy/132-missiles-guided-munitions-hypersonics.md)), quantum PNT
  for when GPS is gone ([135](../engineering/135-quantum-technologies.md)).
- **Strategy:** SpaceX ([38](../companies/38-spacex-rapid-iteration.md)), the new
  defense cohort ([121](../companies/121-new-defense-tech-cohort.md)), the defense
  playbook ([11](../career/11-defense-aerospace-playbook.md)).
