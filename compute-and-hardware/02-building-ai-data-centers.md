...
This module sits at the intersection of silicon, power, and thermodynamics. It builds on [02-software-gpu-and-parallel-computing.md](../software/02-gpu-and-parallel-computing.md) (what the GPUs actually do), [08-engineering-thermal-management.md](../engineering/08-thermal-management.md) (how heat moves), and [04-engineering-power-electronics.md](../engineering/04-power-electronics.md) (transformers, rectification, conversion losses). It is consumed by [06-software-mlops-and-ml-infrastructure.md](../software/06-mlops-and-ml-infrastructure.md) and [10-software-cloud-and-kubernetes.md](../software/10-cloud-and-kubernetes.md), which schedule workloads onto this iron. The strategic frame comes from [06-companies-nvidia-platform-ecosystem.md](../companies/06-nvidia-platform-ecosystem.md) (who controls the stack) and [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md) (where the durable moats are). Its sequel — [03-compute-distributed-data-centers-and-startup-ideas.md](03-distributed-data-centers-and-startup-ideas.md) — uses everything here to dissect a real distributed-compute startup and propose better bets.
...
- **Behind-the-meter deals** co-locating directly at a power plant (this is a central theme of [03-compute-distributed-data-centers-and-startup-ideas.md](03-distributed-data-centers-and-startup-ideas.md)).
...
A poorly designed chain at $0.97^5 \approx 0.86$ wastes 14% of all energy *before a single FLOP*. This is why hyperscalers push toward **higher-voltage DC distribution** (e.g., 800 VDC architectures NVIDIA is championing for the Rubin generation) — fewer conversions, less copper, less loss. See [04-engineering-power-electronics.md](../engineering/04-power-electronics.md) for the device physics.
...
Both are NVIDIA-owned product lines (Mellanox acquisition) — a reminder from [06-companies-nvidia-platform-ecosystem.md](../companies/06-nvidia-platform-ecosystem.md) that NVIDIA sells you the GPU *and* the network *and* the switches. The moat is the **system**, not the chip.
...
This is why the map of AI data centers clusters around: **retired power plants** (instant grid tie), **ERCOT/Texas** (cheap, fast-permitting, abundant gas + wind), **the Nordics** (free cooling, hydro), **Virginia ("Data Center Alley")** for legacy fiber + cloud gravity, and increasingly **anywhere with a willing utility and surplus generation.** The asymmetric founders covered in [11-companies-startup-asymmetric-playbook.md](../companies/11-startup-asymmetric-playbook.md) win by finding *stranded* power others overlooked.
