...
This module is the applied sequel to [02-compute-building-ai-data-centers.md](02-building-ai-data-centers.md); read it first — every term here (speed-to-power, PUE, kW/rack, behind-the-meter, training vs inference) is defined there. It draws its evaluative lens from [11-companies-startup-asymmetric-playbook.md](../companies/11-startup-asymmetric-playbook.md) (asymmetric bets, founder edge) and [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md) (durable moats vs temporary cleverness). The hardware realities trace back to [04-engineering-power-electronics.md](../engineering/04-power-electronics.md), [08-engineering-thermal-management.md](../engineering/08-thermal-management.md), and [02-software-gpu-and-parallel-computing.md](../software/02-gpu-and-parallel-computing.md); the orchestration challenge connects to [06-software-mlops-and-ml-infrastructure.md](../software/06-mlops-and-ml-infrastructure.md), [10-software-cloud-and-kubernetes.md](../software/10-cloud-and-kubernetes.md), and the platform dynamics of [06-companies-nvidia-platform-ecosystem.md](../companies/06-nvidia-platform-ecosystem.md).
...
- **The pitch.** Close the **"speed-to-power gap"** (see [02-compute-building-ai-data-centers.md](02-building-ai-data-centers.md) §3) by deploying inference capacity at the **grid edge**, physically *proximal to users* — low latency for inference and cloud gaming — **augmenting, not replacing** centralized data centers.
...
From [02-compute-building-ai-data-centers.md](02-building-ai-data-centers.md): grid interconnection queues run **4–7 years**, transformers have multi-year lead times, and a stranded GPU burns a third of its life waiting. If XFRA can energize capacity in **weeks** by using *existing* residential service drops, it sidesteps the single worst bottleneck in the industry. That is not a marginal improvement; it is a different time-constant.
...
Now the constructive half. Each bet is scored on the asymmetric-playbook lens from [11-companies-startup-asymmetric-playbook.md](../companies/11-startup-asymmetric-playbook.md): *Does it exploit a real asymmetry? Is the moat durable? Does it ride a tailwind others can't?* These are stronger-*shaped* bets — not guarantees, but better risk/reward geometry than putting enterprise GPUs in strangers' garages.
...
- **Asymmetry:** Hard tech, real IP, defensible. Connects to [08-engineering-thermal-management.md](../engineering/08-thermal-management.md) and [04-engineering-power-electronics.md](../engineering/04-power-electronics.md).
...
- **Risk:** NVIDIA/labs may absorb the best ideas into the stack (the [06-companies-nvidia-platform-ecosystem.md](../companies/06-nvidia-platform-ecosystem.md) commoditization risk).
...
- **"The Lean Startup" / "Zero to One"** (Ries; Thiel) paired with [11-companies-startup-asymmetric-playbook.md](../companies/11-startup-asymmetric-playbook.md) — for judging whether an asymmetry is real and durable.
