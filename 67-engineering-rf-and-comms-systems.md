...
RF is applied [03-foundations-mathematics.md](03-foundations-mathematics.md): Fourier analysis, complex baseband, and probability are the native language of the channel. The digital back-ends that make modern radios possible are the FPGAs of [66-engineering-fpga-and-hardware-accel.md](66-engineering-fpga-and-hardware-accel.md) and the firmware of [65-engineering-embedded-firmware.md](65-engineering-embedded-firmware.md). The systems-level tradeoffs — range vs. data rate vs. power vs. probability of intercept — are exactly the kind of first-principles balancing of [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md). This module connects directly to the electronic-warfare and GNSS material in [26-autonomy-gnss-jamming-spoofing.md](26-autonomy-gnss-jamming-spoofing.md) and [27-autonomy-counter-uas-ew.md](27-autonomy-counter-uas-ew.md): a link budget is also a *jam* budget, and the antenna that closes your link is the aperture an adversary exploits.
...
This is the direct bridge to [26-autonomy-gnss-jamming-spoofing.md](26-autonomy-gnss-jamming-spoofing.md): a jammer's job is to overcome your processing gain with raw power; the **jam-to-signal ratio** the receiver tolerates is the design battleground.
...
SDR platforms (USRP/Ettus, BladeRF, HackRF, RFSoC) plus GNU Radio let you build a working receiver or transmitter in a flowgraph in an afternoon, then push the heavy lifting into an FPGA for real-time performance — the exact PS/PL split of [66-engineering-fpga-and-hardware-accel.md](66-engineering-fpga-and-hardware-accel.md). SDR is also the universal tool for EW, signals intelligence, and GPS research: one box, reprogrammable to any waveform.
