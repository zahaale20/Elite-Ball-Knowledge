...
This deep dive sits under [37-companies-how-the-giants-win.md](37-companies-how-the-giants-win.md). Its ecosystem/lock-in logic pairs with Apple's platform story ([43-companies-apple-integration-taste.md](43-companies-apple-integration-taste.md)), its long-horizon-bet theme with SpaceX/Tesla conviction ([38](38-companies-spacex-rapid-iteration.md), [41](41-companies-tesla-vertical-integration-data.md)), and its relevance to your work with the AI/ML spine in [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md) and the strategy foundations in [08-foundations-company-strategy-moat.md](08-foundations-company-strategy-moat.md).
...
3. **Network effects.** More CUDA developers → more CUDA software → more reasons to buy Nvidia → more developers. This is the $N^2$ network-effect moat from [37](37-companies-how-the-giants-win.md).
...
Owning the full stack means Nvidia captures value at *every* layer and controls the optimization across layers (hardware + software co-design). It also means a customer adopting Nvidia adopts an entire integrated world, deepening lock-in at each level. This is the same "own the integration layer" instinct as Anduril's Lattice ([39](39-companies-anduril-productized-defense.md)) and Apple's hardware/software marriage ([43](43-companies-apple-integration-taste.md)), applied to compute.
