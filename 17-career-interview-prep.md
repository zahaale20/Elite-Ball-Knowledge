...
Pair this with [12-career-software-engineering.md](12-career-software-engineering.md)
(what to learn) and [18-career-resume-portfolio.md](18-career-resume-portfolio.md)
...
[12-career-software-engineering.md](12-career-software-engineering.md) §0:
...
1. **Recruiter screen (20–30 min)** — interest, basics, clearance/citizenship,
   ...
   clearance answer; details in [16-career-security-clearance.md](16-career-security-clearance.md).)
...
5. **Debrief & decision** — interviewers write structured feedback; a committee or
   ...
   ([15-career-negotiation-compensation.md](15-career-negotiation-compensation.md)).
...
Cross-link: [25-autonomy-control-theory.md](25-autonomy-control-theory.md) and
...
- Cross-link: [29-autonomy-planning-decision.md](29-autonomy-planning-decision.md).
...
> wins a take-home. See [18-career-resume-portfolio.md](18-career-resume-portfolio.md).
...
Cross-link [11-career-defense-aerospace-playbook.md](11-career-defense-aerospace-playbook.md)
...
- **Clearance/citizenship (recruiter screen):** keep it short and honest. *"I'm a
  ...
  [16-career-security-clearance.md](16-career-security-clearance.md) §12.
- **Comp question (recruiter screen):** deflect to range/research; don't anchor low.
  See [15-career-negotiation-compensation.md](15-career-negotiation-compensation.md) §4.
...
- [12-career-software-engineering.md](12-career-software-engineering.md) — *what*
  to learn; this file is *how to perform it under the clock.*
- [18-career-resume-portfolio.md](18-career-resume-portfolio.md) — gets you the
  interview; the loop converts it to an offer.
- [16-career-security-clearance.md](16-career-security-clearance.md) — the gate
  that runs in parallel with the loop.
- [15-career-negotiation-compensation.md](15-career-negotiation-compensation.md) —
  what to do the moment you pass the loop.
- Autonomy band: [22-autonomy-px4-sitl.md](22-autonomy-px4-sitl.md),
...
- [04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md) —
  the C++/real-time depth for §4.
- [02-ten-year-mastery-plan.md](02-ten-year-mastery-plan.md) — slot interview prep
