...
Actuation is where the control theory of [25-autonomy-control-theory.md](25-autonomy-control-theory.md)
becomes torque on a shaft, and where the mechanical reasoning of
[13-career-mechanical-engineering.md](13-career-mechanical-engineering.md) sets the
...
the driver electronics from [78-engineering-pcb-and-electronics-design.md](78-engineering-pcb-and-electronics-design.md);
the energy budget from [79-engineering-batteries-and-energy-storage.md](79-engineering-batteries-and-energy-storage.md).
Reliability of the drivetrain is governed by [77-engineering-reliability-and-failure-analysis.md](77-engineering-reliability-and-failure-analysis.md),
manufacturability of the housing by [75-engineering-manufacturing-and-dfm.md](75-engineering-manufacturing-and-dfm.md),
...
3. **Speed** at the operating point must be below $\omega_0$ with headroom for bus-voltage
   sag (see [79](79-engineering-batteries-and-energy-storage.md)).
...
laws of [25-autonomy-control-theory.md](25-autonomy-control-theory.md) assume away —
...
- **ODrive / SimpleFOC documentation.** Open hardware/software you can actually run, pairing with [78-engineering-pcb-and-electronics-design.md](78-engineering-pcb-and-electronics-design.md).
- **NASA-HDBK-5300 and machine-design texts (Shigley)** for the mechanical drivetrain, linking to [13-career-mechanical-engineering.md](13-career-mechanical-engineering.md).
