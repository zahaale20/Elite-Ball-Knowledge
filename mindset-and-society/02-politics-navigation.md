...
This is the organizational-behavior counterpart to the technical-craft and strategy modules. It pairs with [10-career-leadership-growth.md](../career/10-leadership-growth.md) (the integrity-preserving version of influence), [03-career-software-engineering.md](../career/03-software-engineering.md) (the substance that politics is supposed to reward), and [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md) (why companies are structured the way they are). It draws heavily on [12-companies-operating-mechanisms-and-culture.md](../companies/12-operating-mechanisms-and-culture.md), [08-companies-amazon-mechanisms-customer-obsession.md](../companies/08-amazon-mechanisms-customer-obsession.md), and [09-companies-google-scale-infra.md](../companies/09-google-scale-infra.md) for how the machinery differs by company, and on [13-companies-skills-to-beat-them.md](../companies/13-skills-to-beat-them.md) for the asymmetric skills outsiders use to compete. The government analogue — where the same dynamics wear uniforms and budget cycles — is in [05-career-dod-politics.md](../career/05-dod-politics.md). Its sibling module, [03-bigtech-flaws-and-the-optimal-company.md](03-flaws-and-the-optimal-company.md), zooms out from navigating the machine to critiquing and redesigning it.
...
6. **Keep an exit option.** Your leverage to act with integrity comes from being employable elsewhere. F-you money and a strong external network let you say no to the corrosive game. (See [06-career-negotiation-compensation.md](../career/06-negotiation-compensation.md).)
...
- Companion modules: [10-career-leadership-growth.md](../career/10-leadership-growth.md), [12-companies-operating-mechanisms-and-culture.md](../companies/12-operating-mechanisms-and-culture.md), [13-companies-skills-to-beat-them.md](../companies/13-skills-to-beat-them.md), [03-bigtech-flaws-and-the-optimal-company.md](03-flaws-and-the-optimal-company.md).
