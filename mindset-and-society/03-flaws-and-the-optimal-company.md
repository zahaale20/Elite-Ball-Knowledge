...
This is the zoom-out companion to [02-bigtech-politics-navigation.md](02-politics-navigation.md), which is about surviving inside the machine; this module is about critiquing and redesigning the machine. It builds directly on [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md) (where durable advantage comes from) and [12-companies-operating-mechanisms-and-culture.md](../companies/12-operating-mechanisms-and-culture.md) (how culture is encoded in mechanisms). The company-specific deep dives it argues with are [08-companies-amazon-mechanisms-customer-obsession.md](../companies/08-amazon-mechanisms-customer-obsession.md) and [09-companies-google-scale-infra.md](../companies/09-google-scale-infra.md). The skills an outsider uses to exploit these flaws are in [13-companies-skills-to-beat-them.md](../companies/13-skills-to-beat-them.md), the engineering-craft grounding is in [03-career-software-engineering.md](../career/03-software-engineering.md), and the public-sector analogue of institutional pathology is in [05-career-dod-politics.md](../career/05-dod-politics.md).
...
Amazon's mechanisms (the six-page narrative, working-backwards, single-threaded owners, bar raisers) are genuinely world-class — and covered admiringly in [08-companies-amazon-mechanisms-customer-obsession.md](../companies/08-amazon-mechanisms-customer-obsession.md). The structural flaw is what the *intensity* costs: a churn-and-burn human model.
...
Adopt Amazon's narrative memos and written decision-making: it forces clear thinking, scales context without meetings, and creates a durable record that fights the "ratification-ceremony" politics of [02-bigtech-politics-navigation.md](02-politics-navigation.md). Writing is the cheapest high-bandwidth coordination mechanism at scale.
...
- Companion modules: [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md), [12-companies-operating-mechanisms-and-culture.md](../companies/12-operating-mechanisms-and-culture.md), [13-companies-skills-to-beat-them.md](../companies/13-skills-to-beat-them.md), [02-bigtech-politics-navigation.md](02-politics-navigation.md).
