...
(strategic positioning), and [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md)
...
- **Contested environments.** Adversaries operate in the information domain
  ...
  [27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md) for the EW side).
- **Public narrative and program risk.** Defense programs live and die partly on
  public and political perception
  ([14-career-dod-politics.md](../career/14-dod-politics.md)). Understanding the
...
[29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md), applied to
