...
- **32** → [Social Media Platform Mechanics](02-social-media-platform-mechanics.md)
- **33** → [Cognition, Attention & Narratives](03-cognitive-bias-attention-and-narratives.md)
- **34** → [Information Operations: History & Defense](04-information-operations-history-defense.md)
- **35** → [OSINT, Verification & Sensemaking](05-osint-verification-and-sensemaking.md)
- **36** → [Trust, Safety, OPSEC & Digital Resilience](06-trust-safety-opsec-and-digital-resilience.md)

It connects back to the existing curriculum via
[05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md) (message
propagation), [07-foundations-defense-acquisition.md](../foundations/07-defense-acquisition.md)
(mission and stakeholder context), [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md)
(strategic positioning), and [10-autonomy-planning-decision.md](../autonomy/10-planning-decision.md)
...
- **Contested environments.** Adversaries operate in the information domain
  ...
  [08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md) for the EW side).
- **Public narrative and program risk.** Defense programs live and die partly on
  public and political perception
  ([05-career-dod-politics.md](../career/05-dod-politics.md)). Understanding the
...
[10-autonomy-planning-decision.md](../autonomy/10-planning-decision.md), applied to
