...
- **Time delay is the silent killer** — every sensor filter, comms hop, and
  ...
  fast and deterministic (see [04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md)).
...
in [03-foundations-mathematics.md](03-foundations-mathematics.md)):
...
GNC loop in [28-autonomy-gnc.md](28-autonomy-gnc.md) lives or dies on it.
...
- **The actual state** that every loop differences against comes from **EKF2**
  ([28-autonomy-gnc.md](28-autonomy-gnc.md)) — and in GPS-denied flight from the
  vision pipeline in
...
- **Preview.** If the trajectory ahead is known
  ([29-autonomy-planning-decision.md](29-autonomy-planning-decision.md)), MPC acts
...
faster, and easier to certify ([09-foundations-safety-assurance.md](09-foundations-safety-assurance.md)).
...
plot. Confirm in SITL first ([22-autonomy-px4-sitl.md](22-autonomy-px4-sitl.md)),
...
muscle the [02-ten-year-mastery-plan.md](02-ten-year-mastery-plan.md) is built to
grow.
