...
Observability is where the systems-thinking of [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md) becomes a daily operational reality, and where the test-and-verification mindset of [06-foundations-simulation-test-verification.md](06-foundations-simulation-test-verification.md) extends from pre-flight into production. The career framing of [12-career-software-engineering.md](12-career-software-engineering.md) explains why SRE roles command leverage; the real-time discipline of [04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md) is what your latency budgets are spent on. This module opens the back half of the "Software, Compute & Infrastructure" band and pairs tightly with [89-software-cloud-and-kubernetes.md](89-software-cloud-and-kubernetes.md) (where your services run), [92-software-performance-engineering.md](92-software-performance-engineering.md) (why a latency SLO is violated), [93-software-api-and-system-design.md](93-software-api-and-system-design.md) (what you are observing), and [94-software-testing-and-verification-deep.md](94-software-testing-and-verification-deep.md) (the pre-production half of the same loop). It builds on the distributed-systems foundations in [05_distributed_systems_comms_mesh.md](05_distributed_systems_comms_mesh.md).
...
Autoscaling (covered operationally in [89-software-cloud-and-kubernetes.md](89-software-cloud-and-kubernetes.md)) handles short-term elasticity, but it is not a substitute for capacity planning: scaling has a lag, and you cannot autoscale past a quota or a downstream bottleneck you forgot to provision.
...
A final synthesis: observability and SRE are the production-side mirror of the verification discipline in [06-foundations-simulation-test-verification.md](06-foundations-simulation-test-verification.md) and [94-software-testing-and-verification-deep.md](94-software-testing-and-verification-deep.md). Testing proves the system correct *before* release against known scenarios; observability proves it healthy *after* release against the messy real world. A system you can deploy but cannot observe is a system you cannot honestly claim to operate.
