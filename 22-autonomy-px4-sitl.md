...
> ([21-autonomy-vtol-roadmap.md](21-autonomy-vtol-roadmap.md)), the onboard
> service ([23-autonomy-onboard-system.md](23-autonomy-onboard-system.md)), and
...
- **Determinism.** Two runs with the same inputs produce (nearly) the same flight
  ...
  [24-autonomy-test-scaffold.md](24-autonomy-test-scaffold.md) depend on this.
...
- **Wind.** Gazebo can apply steady and gusting wind. A back-transition that
  ...
  ([21-autonomy-vtol-roadmap.md](21-autonomy-vtol-roadmap.md)) under wind before
  trusting it.
- **GPS dropout.** Inducing GPS loss in SITL is the cheapest way to exercise the
  GPS-denied path and the policy gate's GPS check
  ([23-autonomy-onboard-system.md](23-autonomy-onboard-system.md)) before
  hardware.
...
tests in [24-autonomy-test-scaffold.md](24-autonomy-test-scaffold.md) automate.
...
[21-autonomy-vtol-roadmap.md](21-autonomy-vtol-roadmap.md)). SITL catches logic
...
- **Reproduce deterministically.** Because lockstep is deterministic, a failing
  ...
  params so a test in [24-autonomy-test-scaffold.md](24-autonomy-test-scaffold.md)
  can pin it.
...
([21-autonomy-vtol-roadmap.md](21-autonomy-vtol-roadmap.md) SITL→hardware gates).
...
- Companion guides: roadmap [21-autonomy-vtol-roadmap.md](21-autonomy-vtol-roadmap.md), onboard [23-autonomy-onboard-system.md](23-autonomy-onboard-system.md), tests [24-autonomy-test-scaffold.md](24-autonomy-test-scaffold.md), sim/test foundations [06-foundations-simulation-test-verification.md](06-foundations-simulation-test-verification.md).
