...
This is the natural companion to [118-how-ai-and-llms-actually-work.md](118-how-ai-and-llms-actually-work.md) (AI produces fluent, confident text that *needs* critical evaluation) and draws on the probability of base rates in [../mathematics/96-probability-and-stochastic.md](../mathematics/96-probability-and-stochastic.md). The psychology of why we fall for bad arguments is covered in [../information-environment/33-cognitive-bias-attention-and-narratives.md](../information-environment/33-cognitive-bias-attention-and-narratives.md), and the discipline of honest reasoning connects to [../mindset-and-society/114-life-lessons-people-ignore.md](../mindset-and-society/114-life-lessons-people-ignore.md).
