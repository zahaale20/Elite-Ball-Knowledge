...
This pairs naturally with [118-how-ai-and-llms-actually-work.md](118-how-ai-and-llms-actually-work.md) (most AI runs on servers reached over this network) and [../compute-and-hardware/108-building-ai-data-centers.md](../compute-and-hardware/108-building-ai-data-centers.md) (the physical buildings on the far end of your click). For the foundational idea that there's no software without hardware, see [../compute-and-hardware/110-foundations-no-software-without-hardware.md](../compute-and-hardware/110-foundations-no-software-without-hardware.md).
