...
This connects closely to the technical deep-dive in [../autonomy/20-ml-ai.md](../autonomy/20-ml-ai.md) and the foundation-model material in [../autonomy/63-foundation-models-robotics.md](../autonomy/63-foundation-models-robotics.md). The probability underneath "predicting the next word" is covered in [../mathematics/96-probability-and-stochastic.md](../mathematics/96-probability-and-stochastic.md), and the enormous compute it requires is the subject of [../compute-and-hardware/108-building-ai-data-centers.md](../compute-and-hardware/108-building-ai-data-centers.md). To think clearly about AI's claims, pair it with [120-critical-thinking-and-logical-fallacies.md](120-critical-thinking-and-logical-fallacies.md).
