...
> A standalone companion to [12-software-engineering.md](12-software-engineering.md)
> and [18-resume-portfolio.md](18-resume-portfolio.md). Your code is only as
...
- **Classification discipline shapes everything** — know what can be said where,
  to whom, on which system. (See [124-ethics-export-control.md](124-ethics-export-control.md)
  and [16-security-clearance.md](16-security-clearance.md).)
...
### Connections
- [12-software-engineering.md](12-software-engineering.md) — the technical work this
  communicates.
- [18-resume-portfolio.md](18-resume-portfolio.md) — communication aimed at getting
  hired.
- [117-personal-brand-public-presence.md](117-personal-brand-public-presence.md) —
  communication at scale, in public.
- [19-leadership-growth.md](19-leadership-growth.md) — communication as the core of
  leadership.
