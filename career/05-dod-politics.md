...
```mermaid
flowchart TD
    POTUS[President / Commander-in-Chief] --> SecDef
    SecDef[Secretary of Defense - Civilian] --> OSD[OSD: Policy, Acquisition, Comptroller, Personnel]
    SecDef --> Services[Military Departments: Army / Navy / Air Force]
    SecDef --> COCOMs[11 Combatant Commands]
    CJCS[Chairman, Joint Chiefs] -. advises .-> SecDef
    CJCS --> JointStaff[Joint Staff]
    Services -->|man, train, equip| COCOMs
```
...
- **Brief honestly, especially to oversight.** GAO/IG/Congress remember. A
  ...
  decades (see [10-career-leadership-growth.md](10-leadership-growth.md)).
- **Speak the language in interviews.** Saying "we fielded via the Software
  ...
  [07-career-security-clearance.md](07-security-clearance.md) and the offer
  strategy in [02-career-defense-aerospace-playbook.md](02-defense-aerospace-playbook.md).
...
- [02-career-defense-aerospace-playbook.md](02-defense-aerospace-playbook.md) — turning this fluency into offers.
- [07-career-security-clearance.md](07-security-clearance.md) — the gatekeeper that this guide repeatedly references.
- [08-career-interview-prep.md](08-interview-prep.md) — how to deploy this vocabulary in a loop.
- [10-career-leadership-growth.md](10-leadership-growth.md) — building the durable reputation that is the real "politics."
