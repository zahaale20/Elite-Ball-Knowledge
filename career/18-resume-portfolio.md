...
> ([17-interview-prep.md](17-interview-prep.md)) converts the screen to an offer;
...
- For roles with extra gates (e.g., citizenship or clearance requirements in
  ...
  honestly true. See [16-security-clearance.md](16-security-clearance.md) if that
...
Cross-link [10-aerospace-engineering.md](10-aerospace-engineering.md),
[11-defense-aerospace-playbook.md](11-defense-aerospace-playbook.md),
[12-software-engineering.md](12-software-engineering.md), and
[13-mechanical-engineering.md](13-mechanical-engineering.md) for the
...
- **Open-source contributions:** a merged PR to a project you use is a
  *credential* — it proves you can work in a real, reviewed codebase. Even small,
  well-scoped fixes count. (See [12-software-engineering.md](12-software-engineering.md)
...
- [ ] **Architecture diagram** you can also whiteboard from memory (for the
      interview project round — [17-interview-prep.md](17-interview-prep.md) §7).
...
- [17-interview-prep.md](17-interview-prep.md) — this file gets the
  screen; that file converts it. Your project deep-dive and STAR stories come
  straight from here.
- [16-security-clearance.md](16-security-clearance.md) — if your targets
  require clearance, the eligibility line that lives near the top of the résumé.
- [12-software-engineering.md](12-software-engineering.md) — the
...
- [19-leadership-growth.md](19-leadership-growth.md) — your brand and
...
- For roles that require clearance, see [16-security-clearance.md](16-security-clearance.md).
