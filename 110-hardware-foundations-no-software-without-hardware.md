...
This is the philosophical and physical bedrock under the entire engineering band. It explains *why* the real-time discipline of [04-foundations-modern-cpp-realtime.md](04-foundations-modern-cpp-realtime.md) and [82-software-real-time-operating-systems.md](82-software-real-time-operating-systems.md) exists, *why* the GPU and parallelism of [81-software-gpu-and-parallel-computing.md](81-software-gpu-and-parallel-computing.md) became necessary, and *why* embedded firmware [65-engineering-embedded-firmware.md](65-engineering-embedded-firmware.md) must touch physical addresses directly. It grounds the edge-inference budgets of [64-autonomy-edge-inference-deployment.md](64-autonomy-edge-inference-deployment.md), the energy realities of [68-engineering-power-electronics.md](68-engineering-power-electronics.md), and the signal-integrity world of [78-engineering-pcb-and-electronics-design.md](78-engineering-pcb-and-electronics-design.md). It is first-principles thinking [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md) applied to the computer itself, and its concrete companion is the deep dive [107-hardware-raspberry-pi-deep-dive.md](107-hardware-raspberry-pi-deep-dive.md).
...
1. **Multicore.** Can't make one core much faster → put many cores on a die. This is why parallelism stopped being optional and why [81-software-gpu-and-parallel-computing.md](81-software-gpu-and-parallel-computing.md) exists. It also imposed **Amdahl's Law** on everyone:
...
2. **Specialized accelerators.** General cores are inefficient for narrow workloads → build GPUs, TPUs, NPUs, DSPs, and the Hailo/Coral edge accelerators of [107-hardware-raspberry-pi-deep-dive.md](107-hardware-raspberry-pi-deep-dive.md). A matrix-multiply unit does in one pass what a CPU needs thousands of instructions for, at a fraction of the energy.
...
The engineering takeaway: **optimize data movement before you optimize arithmetic.** Improve cache locality, increase reuse (tiling/blocking), pick contiguous layouts, and reduce precision (INT8 moves 4× fewer bytes — the quantization lever of [64-autonomy-edge-inference-deployment.md](64-autonomy-edge-inference-deployment.md)). The flops are usually free; the bytes are not.
