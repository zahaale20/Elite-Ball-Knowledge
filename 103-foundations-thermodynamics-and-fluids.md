...
This module supplies the energy and flow physics behind the vehicles modeled in [102-foundations-physics-for-engineers.md](102-foundations-physics-for-engineers.md) and controlled in [101-foundations-control-advanced.md](101-foundations-control-advanced.md). Endurance and propulsion tradeoffs feed mission planning in [29-autonomy-planning-decision.md](29-autonomy-planning-decision.md) and the systems budgets of [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md). The calculus and differential-equation tools come from [03-foundations-mathematics.md](03-foundations-mathematics.md); the field analogies (flux, divergence) recur in [104-foundations-electromagnetics.md](104-foundations-electromagnetics.md).
...
A small drone and a jet are *different physics regimes* because they sit at different $Re$ — a scaling insight from [102-foundations-physics-for-engineers.md](102-foundations-physics-for-engineers.md).
...
For autonomy, thermal management is often the *real* limit: a flight computer or motor controller that cannot reject its $I^2R$ losses will throttle or fail. The vehicle's power budget (Section 6) and its thermal-rejection capacity are two sides of the same energy ledger — the kind of coupled constraint [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md) insists you track jointly.
