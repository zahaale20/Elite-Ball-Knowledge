...
[29-autonomy-planning-decision.md](29-autonomy-planning-decision.md) as an MDP and
is the learning counterpart to the model-based optimization of
[55-autonomy-trajectory-optimization.md](55-autonomy-trajectory-optimization.md). It
shares the neural-network and gradient machinery of
[20-autonomy-ml-ai.md](20-autonomy-ml-ai.md), rests on the probability and
optimization of [03-foundations-mathematics.md](03-foundations-mathematics.md), and
ultimately commands the dynamics studied in
[25-autonomy-control-theory.md](25-autonomy-control-theory.md). It pairs tightly
with [57-autonomy-imitation-and-learning-from-demo.md](57-autonomy-imitation-and-learning-from-demo.md),
...
- **MPC with a learned model (e.g., PETS):** plan actions by optimizing predicted
  ...
  [55-autonomy-trajectory-optimization.md](55-autonomy-trajectory-optimization.md).
