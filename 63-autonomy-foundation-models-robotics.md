...
Foundation models for robotics sit at the apex of the autonomy stack, consuming the perception of [59-autonomy-computer-vision.md](59-autonomy-computer-vision.md) and [50-autonomy-perception-deep.md](50-autonomy-perception-deep.md), subsuming or replacing parts of the planning of [29-autonomy-planning-decision.md](29-autonomy-planning-decision.md), and commanding the control of [28-autonomy-gnc.md](28-autonomy-gnc.md). They are the cutting edge of the learning lineage in [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md), are pretrained and validated through the sim-to-real methods of [62-autonomy-sim-to-real.md](62-autonomy-sim-to-real.md), and must be compressed to run onboard via [64-autonomy-edge-inference-deployment.md](64-autonomy-edge-inference-deployment.md). Their prompting craft connects to [30-ai-power-prompts.md](30-ai-power-prompts.md); their attention math rests on [03-foundations-mathematics.md](03-foundations-mathematics.md).
...
- **Data:** **Open X-Embodiment**, **DROID**, **RT-X** datasets; collected via teleoperation and sim ([62-autonomy-sim-to-real.md](62-autonomy-sim-to-real.md)).
- **Infra:** PyTorch + Hugging Face; **TensorRT-LLM / ONNX** for onboard serving ([64-autonomy-edge-inference-deployment.md](64-autonomy-edge-inference-deployment.md)); ROS 2 for the safety layer and skill execution.
