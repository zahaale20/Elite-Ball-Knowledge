...
methods of [56-autonomy-reinforcement-learning.md](56-autonomy-reinforcement-learning.md),
shares the supervised-learning and neural-network machinery of
[20-autonomy-ml-ai.md](20-autonomy-ml-ai.md), and produces policies that command the
dynamics of [25-autonomy-control-theory.md](25-autonomy-control-theory.md). It is a
learned alternative to the explicit planners of
[54-autonomy-motion-planning.md](54-autonomy-motion-planning.md) and
[55-autonomy-trajectory-optimization.md](55-autonomy-trajectory-optimization.md),
rests on the probability of
[03-foundations-mathematics.md](03-foundations-mathematics.md), and must be
...
2. **Guard the learned policy.** As in
   [56-autonomy-reinforcement-learning.md](56-autonomy-reinforcement-learning.md) and
   [29-autonomy-planning-decision.md](29-autonomy-planning-decision.md), wrap the
