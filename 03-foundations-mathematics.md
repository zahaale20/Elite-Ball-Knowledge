...
> [`navigation/`](28-autonomy-gnc.md), see *why* the filter diverges, and fix it
...
[28-autonomy-gnc.md](28-autonomy-gnc.md) (where the EKF lives),
[25-autonomy-control-theory.md](25-autonomy-control-theory.md) (where the dynamics
live), and [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md) (where the statistics show up
again as learning).
...
- **Stability.** A linear system `ẋ = A x` is stable iff every eigenvalue of `A` has
  negative real part. This is the bridge to [control theory](25-autonomy-control-theory.md):
...
hash-chained [`policy/decisions.py`](28-autonomy-gnc.md) log then records *which* hypothesis
...
fully fleshed out in [28-autonomy-gnc.md](28-autonomy-gnc.md).
...
> speed matters. Your **SITL simulator** ([22-autonomy-px4-sitl.md](22-autonomy-px4-sitl.md))
...
[perception stack](20-autonomy-ml-ai.md) (the IMX500 model was trained by a fancy variant —
...
When all six feel routine, re-read [28-autonomy-gnc.md](28-autonomy-gnc.md) — the EKF and
