...
> **Where this sits in the curriculum.** [Module 03 — Guidance, Navigation & Control](28-gnc.md) gave the airframe a *body* that can hold a setpoint and a *nervous system* that knows where it is. This module gives it a *will*: the layer that turns "state of the world" into "correct next action." For the perception and learning machinery this layer consumes — detectors, trackers, deep RL — link out to the companion [ML/RL guide](20-ml-ai.md) rather than duplicating it here. For how multiple airframes share decisions, see [Module 05 — Distributed Systems, Comms & Mesh](../foundations/05-distributed_systems_comms_mesh.md).
>
...
**Connect outward.**
- [ ] Skim the RL section of the [ML/RL guide](20-ml-ai.md) and write one sentence on where a learned policy could slot into the §9 ladder *without* becoming the arbiter of an irreversible action.

---

### Cross-links
- ⬅ **[Module 03 — Guidance, Navigation & Control](28-gnc.md)** — the body & nervous system this layer commands (setpoints, EKF, nav filter, the geofence/nav-loss monitors).
- 🧠 **[ML/RL & Perception Guide](20-ml-ai.md)** — detectors, trackers, appearance embeddings, and deep RL that fill the *leaves* of this decision architecture.
...
> [28-autonomy-gnc.md](28-gnc.md); ML/RL & perception →
> [20-autonomy-ml-ai.md](20-ml-ai.md). Module 05 (distributed
