...
> the autonomy band — SITL ([22-autonomy-px4-sitl.md](22-px4-sitl.md)),
> the onboard system ([23-autonomy-onboard-system.md](23-onboard-system.md)),
> the test scaffold ([24-autonomy-test-scaffold.md](24-test-scaffold.md)),
> control theory ([25-autonomy-control-theory.md](25-control-theory.md)),
> and GNC ([28-autonomy-gnc.md](28-gnc.md)) — hangs off a single,
...
> [02-ten-year-mastery-plan.md](../foundations/02-ten-year-mastery-plan.md) for how this program
...
actuator saturation), see [25-autonomy-control-theory.md](25-control-theory.md)
and the GNC integration in [28-autonomy-gnc.md](28-gnc.md).
...
[23-autonomy-onboard-system.md](23-onboard-system.md) for the
...
- Control allocation background: see [25-autonomy-control-theory.md](25-control-theory.md) and [28-autonomy-gnc.md](28-gnc.md).
- Companion guides: SITL [22-autonomy-px4-sitl.md](22-px4-sitl.md), onboard [23-autonomy-onboard-system.md](23-onboard-system.md), tests [24-autonomy-test-scaffold.md](24-test-scaffold.md), assurance [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md).
