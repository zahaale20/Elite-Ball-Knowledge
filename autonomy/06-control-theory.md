...
> and [09-autonomy-gnc.md](09-gnc.md). GNC's "C" gets its own file
...
- **Learned control (RL)** — neural policies that beat human pilots in drone
  racing (see [01-autonomy-ml-ai.md](01-ml-ai.md)); still maturing for
...
- EKF2 (the estimator from [09-autonomy-gnc.md](09-gnc.md)) supplies
...
- **Where to learn by doing:** tune the rate loop in SITL
  ([03-autonomy-px4-sitl.md](03-px4-sitl.md)), watch the step response
...
GNC loop in [09-autonomy-gnc.md](09-gnc.md) lives or dies on it.
...
- **The actual state** that every loop differences against comes from **EKF2**
  ([09-autonomy-gnc.md](09-gnc.md)) — and in GPS-denied flight from the
  vision pipeline in
  [07-autonomy-gnss-jamming-spoofing.md](07-gnss-jamming-spoofing.md). A
...
- **Preview.** If the trajectory ahead is known
  ([10-autonomy-planning-decision.md](10-planning-decision.md)), MPC acts
...
plot. Confirm in SITL first ([03-autonomy-px4-sitl.md](03-px4-sitl.md)),
