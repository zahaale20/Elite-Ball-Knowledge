...
Sim-to-real is the bridge between the learning of [20-autonomy-ml-ai.md](20-ml-ai.md) and the physical world, and it is inseparable from the simulation, test, and verification rigor of [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md). It is how control policies ([25-autonomy-control-theory.md](25-control-theory.md), [28-autonomy-gnc.md](28-gnc.md)) and planners ([29-autonomy-planning-decision.md](29-planning-decision.md)) are trained safely, how the perception of [50-autonomy-perception-deep.md](50-perception-deep.md) and [59-autonomy-computer-vision.md](59-computer-vision.md) gets synthetic training data, and how the foundation-model policies of [63-autonomy-foundation-models-robotics.md](63-foundation-models-robotics.md) are pretrained. The PX4 SITL workflow of [22-autonomy-px4-sitl.md](22-px4-sitl.md) and the test scaffolding of [24-autonomy-test-scaffold.md](24-test-scaffold.md) are its tooling; the statistics live in [03-foundations-mathematics.md](../foundations/03-mathematics.md).
...
- **SITL for vehicles:** **PX4 SITL / jMAVSim / Gazebo** ([22-autonomy-px4-sitl.md](22-px4-sitl.md)).
- **Calibration / SysID:** differentiable sims (Brax, Tiny Differentiable Simulator, Warp), Bayesian SysID toolkits.
- **Deployment:** the trained policy is quantized and run onboard via [64-autonomy-edge-inference-deployment.md](64-edge-inference-deployment.md).
