...
methods of [56-autonomy-reinforcement-learning.md](56-reinforcement-learning.md),
shares the supervised-learning and neural-network machinery of
[20-autonomy-ml-ai.md](20-ml-ai.md), and produces policies that command the
dynamics of [25-autonomy-control-theory.md](25-control-theory.md). It is a
learned alternative to the explicit planners of
[54-autonomy-motion-planning.md](54-motion-planning.md) and
...
2. **Guard the learned policy.** As in
   [56-autonomy-reinforcement-learning.md](56-reinforcement-learning.md) and
   [29-autonomy-planning-decision.md](29-planning-decision.md), wrap the
