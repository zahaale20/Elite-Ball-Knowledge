...
Vision is the front-end for nearly everything downstream: it feeds the VIO of [61-autonomy-visual-inertial-odometry.md](61-visual-inertial-odometry.md), the SLAM of [51-autonomy-slam-and-mapping.md](51-slam-and-mapping.md), the fusion of [52-autonomy-sensor-fusion.md](52-sensor-fusion.md), and the perception pipelines of [50-autonomy-perception-deep.md](50-perception-deep.md). Its deep-learning half is an application of [20-autonomy-ml-ai.md](20-ml-ai.md); its geometric half is projective linear algebra from [03-foundations-mathematics.md](../foundations/03-mathematics.md); and its outputs drive the planning of [29-autonomy-planning-decision.md](29-planning-decision.md). Edge deployment of the networks is covered in [64-autonomy-edge-inference-deployment.md](64-edge-inference-deployment.md).
