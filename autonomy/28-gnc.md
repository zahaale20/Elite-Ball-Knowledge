...
>
> **Prerequisites:** [Module 01 — First Principles & Systems Engineering](../foundations/01-first_principles_systems_engineering.md).
> **Companions:** [ML/AI Perception & Autonomy](20-ml-ai.md) ·
> [Module 06 — Simulation, Test & Verification](../foundations/06-simulation-test-verification.md).
...
- [Module 01 — First Principles & Systems Engineering](../foundations/01-first_principles_systems_engineering.md)
  — the modeling discipline and budget thinking that GNC stands on.
- [ML/AI Perception & Autonomy](20-ml-ai.md) — where the camera
...
> the ML/perception companion → [20-autonomy-ml-ai.md](20-ml-ai.md);
> control-theory deep dive → [25-autonomy-control-theory.md](25-control-theory.md);
> the planning module → [29-autonomy-planning-decision.md](29-planning-decision.md).
