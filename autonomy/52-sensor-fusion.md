...
Fusion is where the perception of [50-autonomy-perception-deep.md](50-perception-deep.md)
and the maps of [51-autonomy-slam-and-mapping.md](51-slam-and-mapping.md)
meet the estimation core of [28-autonomy-gnc.md](28-gnc.md). The
factor-graph form of fusion (and why smoothing beats filtering) is developed in
[53-autonomy-state-estimation-advanced.md](53-state-estimation-advanced.md).
...
[25-autonomy-control-theory.md](25-control-theory.md). Validate every
...
[28-autonomy-gnc.md](28-gnc.md)). For fusion the structure is:
...
[51-autonomy-slam-and-mapping.md](51-slam-and-mapping.md) §8). A
