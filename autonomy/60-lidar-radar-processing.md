...
Point-cloud and radar processing feed the fusion stack of [52-autonomy-sensor-fusion.md](52-sensor-fusion.md), the SLAM/mapping of [51-autonomy-slam-and-mapping.md](51-slam-and-mapping.md), and the state estimation of [53-autonomy-state-estimation-advanced.md](53-state-estimation-advanced.md). It complements the camera geometry of [59-autonomy-computer-vision.md](59-computer-vision.md) and the perception pipelines of [50-autonomy-perception-deep.md](50-perception-deep.md). The deep models for point clouds extend [20-autonomy-ml-ai.md](20-ml-ai.md); the signal-processing math draws on [03-foundations-mathematics.md](../foundations/03-mathematics.md); and the all-weather robustness it provides is essential to the planning of [29-autonomy-planning-decision.md](29-planning-decision.md). Radar's anti-jam relevance ties to [26-autonomy-gnss-jamming-spoofing.md](26-gnss-jamming-spoofing.md).
...
The enabling prerequisites are **extrinsic calibration** (the rigid transform between each sensor frame — get this wrong and fused points smear) and **temporal synchronization** (hardware-triggered or timestamp-interpolated; a moving object at 20 m/s moves 0.2 m in 10 ms of sync error). Fusion then rides the estimators of [52-autonomy-sensor-fusion.md](52-sensor-fusion.md): a Kalman/IMM tracker that updates object state from whichever sensor reports, weighting each by its measurement covariance.
