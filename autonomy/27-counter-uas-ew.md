...
> [26-autonomy-gnss-jamming-spoofing.md](26-gnss-jamming-spoofing.md)
...
- **Cyber/protocol takeover** — exploit weak command links or unauthenticated
  ...
  [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md)).
...
[20-autonomy-ml-ai.md](20-ml-ai.md), the GPS-denied navigation in
[28-autonomy-gnc.md](28-gnc.md), and the decision logic in
[29-autonomy-planning-decision.md](29-planning-decision.md) are all,
...
- **Noise jamming** (barrage / spot / swept) — raise the noise floor on the link or
  GNSS band ([26-autonomy-gnss-jamming-spoofing.md](26-gnss-jamming-spoofing.md) §8).
- **Deception jamming / DRFM.** Digital RF Memory captures a signal, modifies it,
  ...
  GNSS spoofing.
- **GNSS denial/spoofing** — covered in [26-autonomy-gnss-jamming-spoofing.md](26-gnss-jamming-spoofing.md).
...
- **Fusion.** Modern systems combine all four to **cut false alarms** (birds,
  ...
  stack solves on the friendly side ([28-autonomy-gnc.md](28-gnc.md)).
...
3. **Three+ sensors → TDOA hyperbolas.** Your emission reaches each sensor at a
   ...
   [26-autonomy-gnss-jamming-spoofing.md](26-gnss-jamming-spoofing.md) §9
   cut both ways).
...
- **Cyber / protocol takeover.** Exploit unauthenticated or weakly-authenticated
  ...
  secure boot, and signed firmware (see [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md)).
...
| GNSS jam / spoof | **VIO + map-match + EKF2 EV fusion**, GNSS-integrity monitor (link [26](26-gnss-jamming-spoofing.md)) |
| Cyber / protocol takeover | **Encrypted + authenticated + frequency-hopping C2** when a link *is* used; secure boot; signed firmware ([32](../foundations/05-distributed_systems_comms_mesh.md)) |
...
autonomy in [20-autonomy-ml-ai.md](20-ml-ai.md), the GPS-denied navigation
in [26-autonomy-gnss-jamming-spoofing.md](26-gnss-jamming-spoofing.md), the
estimation/control in [28-autonomy-gnc.md](28-gnc.md) and
[25-autonomy-control-theory.md](25-control-theory.md), and the decision
logic in [29-autonomy-planning-decision.md](29-planning-decision.md) are —
...
- Lethal autonomy raises serious Law of Armed Conflict (LOAC) and policy
  ...
  accountable. See [14-career-dod-politics.md](../career/14-dod-politics.md).
