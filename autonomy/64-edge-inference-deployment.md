...
Edge deployment is the final, mandatory stage for every learned component in this curriculum: the vision of [59-autonomy-computer-vision.md](59-computer-vision.md), the point-cloud nets of [60-autonomy-lidar-radar-processing.md](60-lidar-radar-processing.md), the VIO of [61-autonomy-visual-inertial-odometry.md](61-visual-inertial-odometry.md), and the foundation models of [63-autonomy-foundation-models-robotics.md](63-foundation-models-robotics.md) all bottleneck here. It realizes the training of [20-autonomy-ml-ai.md](20-ml-ai.md) on real silicon, enforces the real-time guarantees the control loops of [28-autonomy-gnc.md](28-gnc.md) and planners of [29-autonomy-planning-decision.md](29-planning-decision.md) depend on, lives inside the onboard architecture of [23-autonomy-onboard-system.md](23-onboard-system.md), and rests on the numerical foundations of [03-foundations-mathematics.md](../foundations/03-mathematics.md) and the real-time systems craft of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md).
...
| **Integration** | Closed-loop stability with real latency | Hardware-in-the-loop, sim ([62-autonomy-sim-to-real.md](62-sim-to-real.md)) |
