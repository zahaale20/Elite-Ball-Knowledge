...
Swarm autonomy sits downstream of single-agent competence: each member still needs the estimation of [53-autonomy-state-estimation-advanced.md](53-state-estimation-advanced.md), the planning of [29-autonomy-planning-decision.md](29-planning-decision.md), the control of [28-autonomy-gnc.md](28-gnc.md), and the learning of [20-autonomy-ml-ai.md](20-ml-ai.md). What changes is the *substrate*: coordination rides on the mesh networking and consistency models of [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md), and the consensus math is pure linear algebra and graph theory from [03-foundations-mathematics.md](../foundations/03-mathematics.md). It pairs tightly with motion planning ([54-autonomy-motion-planning.md](54-motion-planning.md)) and feeds the foundation-model planners of [63-autonomy-foundation-models-robotics.md](63-foundation-models-robotics.md).
...
For *search* (unknown target locations), agents maintain a shared occupancy/probability map (consensus-fused) and steer up the information gradient — mutual-information or coverage-frontier objectives, linking to the active-perception ideas in [50-autonomy-perception-deep.md](50-perception-deep.md).
...
A layered test strategy (echoing [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md) and [24-autonomy-test-scaffold.md](24-test-scaffold.md)):
