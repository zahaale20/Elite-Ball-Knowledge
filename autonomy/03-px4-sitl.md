...
> ([02-autonomy-vtol-roadmap.md](02-vtol-roadmap.md)), the onboard
> service ([04-autonomy-onboard-system.md](04-onboard-system.md)), and
...
[02-autonomy-vtol-roadmap.md](02-vtol-roadmap.md)).
...
- **Determinism.** Two runs with the same inputs produce (nearly) the same flight
  ...
  [05-autonomy-test-scaffold.md](05-test-scaffold.md) depend on this.
...
- **Wind.** Gazebo can apply steady and gusting wind. A back-transition that
  ...
  ([02-autonomy-vtol-roadmap.md](02-vtol-roadmap.md)) under wind before
  trusting it.
- **GPS dropout.** Inducing GPS loss in SITL is the cheapest way to exercise the
  GPS-denied path and the policy gate's GPS check
  ([04-autonomy-onboard-system.md](04-onboard-system.md)) before
  hardware.
...
tests in [05-autonomy-test-scaffold.md](05-test-scaffold.md) automate.
...
[02-autonomy-vtol-roadmap.md](02-vtol-roadmap.md)). SITL catches logic
...
- **Reproduce deterministically.** Because lockstep is deterministic, a failing
  ...
  params so a test in [05-autonomy-test-scaffold.md](05-test-scaffold.md)
  can pin it.
...
([02-autonomy-vtol-roadmap.md](02-vtol-roadmap.md) SITL→hardware gates).
