...
[01-autonomy-ml-ai.md](01-ml-ai.md), the GPS-denied navigation in
[09-autonomy-gnc.md](09-gnc.md), and the decision logic in
[10-autonomy-planning-decision.md](10-planning-decision.md) are all,
...
- **Noise jamming** (barrage / spot / swept) — raise the noise floor on the link or
  GNSS band ([07-autonomy-gnss-jamming-spoofing.md](07-gnss-jamming-spoofing.md) §8).
- **Deception jamming / DRFM.** Digital RF Memory captures a signal, modifies it,
  ...
  GNSS spoofing.
- **GNSS denial/spoofing** — covered in [07-autonomy-gnss-jamming-spoofing.md](07-gnss-jamming-spoofing.md).
...
- **Fusion.** Modern systems combine all four to **cut false alarms** (birds,
  ...
  stack solves on the friendly side ([09-autonomy-gnc.md](09-gnc.md)).
...
3. **Three+ sensors → TDOA hyperbolas.** Your emission reaches each sensor at a
   ...
   [07-autonomy-gnss-jamming-spoofing.md](07-gnss-jamming-spoofing.md) §9
   cut both ways).
...
| GNSS jam / spoof | **VIO + map-match + EKF2 EV fusion**, GNSS-integrity monitor (link [07](07-gnss-jamming-spoofing.md)) |
...
autonomy in [01-autonomy-ml-ai.md](01-ml-ai.md), the GPS-denied navigation
in [07-autonomy-gnss-jamming-spoofing.md](07-gnss-jamming-spoofing.md), the
estimation/control in [09-autonomy-gnc.md](09-gnc.md) and
[06-autonomy-control-theory.md](06-control-theory.md), and the decision
logic in [10-autonomy-planning-decision.md](10-planning-decision.md) are —
...
- Lethal autonomy raises serious Law of Armed Conflict (LOAC) and policy
  ...
  accountable. See [05-career-dod-politics.md](../career/05-dod-politics.md).
