...
[28-autonomy-gnc.md](28-gnc.md) and the decision layer of
[29-autonomy-planning-decision.md](29-planning-decision.md). The
learning-based detectors it relies on are developed in
[20-autonomy-ml-ai.md](20-ml-ai.md); the probability and linear algebra
it assumes live in [03-foundations-mathematics.md](../foundations/03-mathematics.md).
Its output is consumed directly by [51-autonomy-slam-and-mapping.md](51-slam-and-mapping.md)
and fused with other modalities in [52-autonomy-sensor-fusion.md](52-sensor-fusion.md).
...
[51-autonomy-slam-and-mapping.md](51-slam-and-mapping.md) §6):
...
magnitude faster (see [52-autonomy-sensor-fusion.md](52-sensor-fusion.md)).
...
| Lag behind fast target | latency not modeled | timestamp + predict to measurement time (§[52](52-sensor-fusion.md)) |
