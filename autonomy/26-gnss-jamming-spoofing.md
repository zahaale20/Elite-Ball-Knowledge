...
> [28-autonomy-gnc.md](28-gnc.md) and [20-autonomy-ml-ai.md](20-ml-ai.md)
...
- **Visual-Inertial Odometry (VIO):** fuse camera + IMU to estimate motion with
  ...
  ORB-SLAM in [20-autonomy-ml-ai.md](20-ml-ai.md).)
...
- **Multi-sensor fusion (EKF):** the estimator that weights all of the above and
  **down-weights or rejects GNSS** when integrity checks fail. This is the
  payoff of [28-autonomy-gnc.md](28-gnc.md) — the filter is your immune
...
- Make the EKF able to **drop GPS and hold on VIO/INS** — and test the handoff in
  SITL by killing the simulated GPS mid-mission ([22-autonomy-px4-sitl.md](22-px4-sitl.md)).
...
- These enter EKF2 as **external vision** via `vehicle_visual_odometry` /
  ...
  - `EKF2_EV_DELAY` — **time-offset compensation** so the (latent) vision estimate
    ...
    eats control margin ([25-autonomy-control-theory.md](25-control-theory.md) §14).
...
in your `policy/` layer ([29-autonomy-planning-decision.md](29-planning-decision.md))
...
[28-autonomy-gnc.md](28-gnc.md); the linear-algebra footing is in
...
- **In mission.** Practice **EMCON** (emission control, see
  [27-autonomy-counter-uas-ew.md](27-counter-uas-ew.md)) — an RF-silent,
...
[27-autonomy-counter-uas-ew.md](27-counter-uas-ew.md), and is a core
