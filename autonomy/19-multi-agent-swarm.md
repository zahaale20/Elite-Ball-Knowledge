...
Swarm autonomy sits downstream of single-agent competence: each member still needs the estimation of [14-autonomy-state-estimation-advanced.md](14-state-estimation-advanced.md), the planning of [10-autonomy-planning-decision.md](10-planning-decision.md), the control of [09-autonomy-gnc.md](09-gnc.md), and the learning of [01-autonomy-ml-ai.md](01-ml-ai.md). What changes is the *substrate*: coordination rides on the mesh networking and consistency models of [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md), and the consensus math is pure linear algebra and graph theory from [03-foundations-mathematics.md](../foundations/03-mathematics.md). It pairs tightly with motion planning ([15-autonomy-motion-planning.md](15-motion-planning.md)) and feeds the foundation-model planners of [24-autonomy-foundation-models-robotics.md](24-foundation-models-robotics.md).
...
**Key spectral facts** (from [03-foundations-mathematics.md](../foundations/03-mathematics.md)):
...
For *search* (unknown target locations), agents maintain a shared occupancy/probability map (consensus-fused) and steer up the information gradient — mutual-information or coverage-frontier objectives, linking to the active-perception ideas in [11-autonomy-perception-deep.md](11-perception-deep.md).

---

## 7. Coordination over a Real Mesh

Everything above assumes messages arrive. They don't. Swarm comms is where [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md) becomes survival-critical:
...
A layered test strategy (echoing [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md) and [05-autonomy-test-scaffold.md](05-test-scaffold.md)):
...
Real systems and references: **ROS 2** with multi-robot DDS domains, **Gazebo / NVIDIA Isaac Sim** for swarm simulation, **Crazyswarm / Crazyflie** for indoor drone-swarm research, **PX4** with onboard MAVLink mesh for outdoor fleets ([03-autonomy-px4-sitl.md](03-px4-sitl.md)), and the academic lineage of Olfati-Saber, Bullo, and the GRASP/Kumar lab quadrotor swarms. Production defense swarms layer in robust consensus, anti-jam waveforms, and human-on-the-loop intent injection.
