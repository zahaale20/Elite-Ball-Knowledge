...
| `sitl.md`               | PX4 SITL bring-up notes (now [22-autonomy-px4-sitl.md](22-px4-sitl.md)) |
| `ROADMAP.md`            | Program source of truth (now [21-autonomy-vtol-roadmap.md](21-vtol-roadmap.md)) |
...
- **Pure and testable.** The gate is a pure function of (command, world state) →
  ...
  [24-autonomy-test-scaffold.md](24-test-scaffold.md)).

This is the software half of the SITL→hardware gates in
[21-autonomy-vtol-roadmap.md](21-vtol-roadmap.md): the preflight gate
...
- **No SITL on the Pi.** The Pi talks to the *real* Pixhawk only; SITL lives on
  the laptop ([22-autonomy-px4-sitl.md](22-px4-sitl.md)).
...
- Companion guides: roadmap [21-autonomy-vtol-roadmap.md](21-vtol-roadmap.md), SITL [22-autonomy-px4-sitl.md](22-px4-sitl.md), tests [24-autonomy-test-scaffold.md](24-test-scaffold.md), GNC [28-autonomy-gnc.md](28-gnc.md), assurance [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md).
