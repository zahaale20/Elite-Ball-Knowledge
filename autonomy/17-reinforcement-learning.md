...
[10-autonomy-planning-decision.md](10-planning-decision.md) as an MDP and
is the learning counterpart to the model-based optimization of
[16-autonomy-trajectory-optimization.md](16-trajectory-optimization.md). It
shares the neural-network and gradient machinery of
[01-autonomy-ml-ai.md](01-ml-ai.md), rests on the probability and
...
[06-autonomy-control-theory.md](06-control-theory.md). It pairs tightly
with [18-autonomy-imitation-and-learning-from-demo.md](18-imitation-and-learning-from-demo.md),
...
[13-autonomy-sensor-fusion.md](13-sensor-fusion.md)).
