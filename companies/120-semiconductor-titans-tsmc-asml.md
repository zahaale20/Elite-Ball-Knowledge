...
This module is the company-strategy counterpart to the hardware-foundations band — read it with [110-foundations-no-software-without-hardware.md](../compute-and-hardware/110-foundations-no-software-without-hardware.md) and [108-building-ai-data-centers.md](../compute-and-hardware/108-building-ai-data-centers.md). It sits directly beneath [42-companies-nvidia-platform-ecosystem.md](42-nvidia-platform-ecosystem.md) (Nvidia designs; TSMC builds) and [118-companies-frontier-ai-labs.md](118-frontier-ai-labs.md) (the labs' compute moat bottoms out here). The moat theory is in [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md) and [37-companies-how-the-giants-win.md](37-how-the-giants-win.md); the geopolitics connect to [14-career-dod-politics.md](../career/14-dod-politics.md).
...
- **The moat is human and institutional**, the same way the defense primes' integration moat ([116](116-defense-primes-how-incumbents-win.md)) and the frontier labs' execution moat ([118](118-frontier-ai-labs.md)) are. The pattern recurs across the band: *the deepest moats are accumulated know-how that money cannot carry out the door.*
...
2. **Trailing-edge is a feature, not a bug.** Most embedded/autonomy work does *not* need a 3 nm part. Mature nodes are cheaper, more available, more robust, and less export-entangled — often the *right* engineering choice ([65-embedded-firmware](../engineering/65-embedded-firmware.md)).
3. **Compute is a strategic resource, not an infinite utility.** The frontier-lab compute moat ([118](118-frontier-ai-labs.md)) and your edge-inference budget ([64](../autonomy/64-edge-inference-deployment.md)) both bottom out here. Treat compute as scarce and design for efficiency.
...
- [110-foundations-no-software-without-hardware.md](../compute-and-hardware/110-foundations-no-software-without-hardware.md) — the hardware-substrate foundation.
- [42-companies-nvidia-platform-ecosystem.md](42-nvidia-platform-ecosystem.md) — the designer that TSMC builds for.
- [118-companies-frontier-ai-labs.md](118-frontier-ai-labs.md) — the compute moat that bottoms out here.
- [108-building-ai-data-centers.md](../compute-and-hardware/108-building-ai-data-centers.md) — where these chips get deployed at scale.
