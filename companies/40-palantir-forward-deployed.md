...
This is the *switching-cost* moat from the band overview ([37](37-how-the-giants-win.md)), and it is arguably the stickiest moat type that exists, because it's woven into the customer's daily operations. You don't churn off the system you run your war / your bank / your hospital on.
...
- **Key-person and culture risk.** The model depends on unusually capable, mission-driven engineers willing to embed. That talent density (see [37](37-how-the-giants-win.md)) is hard to maintain at scale.
