...
This deep dive sits under [37-companies-how-the-giants-win.md](37-how-the-giants-win.md). It rhymes strongly with SpaceX's design-to-cost and integration story ([38-companies-spacex-rapid-iteration.md](38-spacex-rapid-iteration.md)), shares the data-moat logic with Palantir's ontology ([40-companies-palantir-forward-deployed.md](40-palantir-forward-deployed.md)), and connects to the autonomy/ML spine in [20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md) and the first-principles habit in [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md).
...
- **It changes the iteration cadence.** Tesla ships software improvements continuously; legacy automakers ship them at the next *model year*. That's a 100× cadence difference (see the iteration logic in [38](38-spacex-rapid-iteration.md)).
...
The unifying principle (same as SpaceX in [38](38-spacex-rapid-iteration.md)): **integrate the parts that gate your core loop or carry the most cost/differentiation; buy the commodities.** Tesla owns the battery and the software because those *are* the product and the moat. It doesn't make its own tires.
...
If the quoted price is far above $C_{\text{first-principles}}$, the gap is *opportunity*, not destiny. This is the same cognitive move as "design-to-cost" and "the Algorithm" from [38](38-spacex-rapid-iteration.md): refuse to accept a cost as given; decompose it to physics and rebuild it cheaper.
...
3. **It's where scale economies live.** Unit cost falls with manufacturing volume and yield — the $1/C$ moat from [37](37-how-the-giants-win.md).
...
- **Autonomy is unsolved.** The data flywheel is real, but full self-driving has been "next year" for many years; data abundance has *not* trivially produced human-level autonomy. Data is necessary, not sufficient — see the hard problems in [20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md) and [28-autonomy-gnc.md](../autonomy/28-gnc.md).
- **Over-automation risk.** "The machine that builds the machine" nearly sank Model 3; automating too early/too much is a real failure mode (echoing "automate last" from [38](38-spacex-rapid-iteration.md)).
