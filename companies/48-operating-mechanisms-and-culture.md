...
Google's data and SRE discipline ([45-companies-google-scale-infra.md](45-google-scale-infra.md)),
and the Skunk Works team model ([46-companies-skunkworks-rapid-prototyping.md](46-skunkworks-rapid-prototyping.md))
— into transferable machinery. It is the *organizational* counterpart to the *competitive* strategy
in [47-companies-startup-asymmetric-playbook.md](47-startup-asymmetric-playbook.md), feeds
the personal-skills synthesis in [49-companies-skills-to-beat-them.md](49-skills-to-beat-them.md),
and connects to the people-and-influence themes in
[19-career-leadership-growth.md](../career/19-leadership-growth.md) and the hiring lens of
[17-career-interview-prep.md](../career/17-interview-prep.md).
...
doors** ([44](44-amazon-mechanisms-customer-obsession.md)) is the canonical tool: reversible
...
- **It forces clear thinking.** You cannot write a muddy idea in clear prose; the act of writing
  *is* the act of thinking ([44](44-amazon-mechanisms-customer-obsession.md) §3).
...
The balanced stance (from [45](45-google-scale-infra.md)): **data-driven by default,
...
[46](46-skunkworks-rapid-prototyping.md)).
...
[17-career-interview-prep.md](../career/17-interview-prep.md)), an outside bar-raiser veto, a defined
...
Amazon COE, [44](44-amazon-mechanisms-customer-obsession.md), [45](45-google-scale-infra.md)).
...
**On the product:** tight customer feedback loops ([47](47-startup-asymmetric-playbook.md) §8) —
...
|---|---|---|
| Promote for *launching* new things | Product graveyard; nobody maintains ([45](45-google-scale-infra.md)) | Reward durable impact, not launches |
| Reward *team size* managed | Empire-building, bloat | Reward output, not headcount (Kelly Johnson Rule 14, [46](46-skunkworks-rapid-prototyping.md)) |
...
in [47](47-startup-asymmetric-playbook.md) and the equity argument in
...
another (Amazon's frugality → labor costs, [44](44-amazon-mechanisms-customer-obsession.md) §10).
...
- **OKR cadence:** quarterly objective-setting and grading ([45](45-google-scale-infra.md)).
...
Skunk Works "minimum reports" rule, [46](46-skunkworks-rapid-prototyping.md)).
...
leadership transition described in [19-career-leadership-growth.md](../career/19-leadership-growth.md).
