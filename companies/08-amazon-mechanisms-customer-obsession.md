...
This module is the *mechanism-level* companion to [12-companies-operating-mechanisms-and-culture.md](12-operating-mechanisms-and-culture.md)
(the cross-company synthesis) and to [08-foundations-company-strategy-moat.md](../foundations/08-company-strategy-moat.md)
(why the flywheel is a moat, not a slogan). It pairs with [09-companies-google-scale-infra.md](09-google-scale-infra.md)
as the "two cultures" contrast — Amazon's *narrative + ownership* against Google's *infrastructure +
data*. The personal-skill translations feed directly into [13-companies-skills-to-beat-them.md](13-skills-to-beat-them.md)
and your own [02-ten-year-mastery-plan.md](../foundations/02-ten-year-mastery-plan.md). For how the writing habit
becomes a leadership multiplier, see [10-career-leadership-growth.md](../career/10-leadership-growth.md).
...
whole module, which is why [13-companies-skills-to-beat-them.md](13-skills-to-beat-them.md)
ranks written communication so highly. See also [01-ai-power-prompts.md](../tooling/01-ai-power-prompts.md):
...
[13-companies-skills-to-beat-them.md](13-skills-to-beat-them.md) calls "owning the full
...
to the OODA-loop speed argument in [11-companies-startup-asymmetric-playbook.md](11-startup-asymmetric-playbook.md).
