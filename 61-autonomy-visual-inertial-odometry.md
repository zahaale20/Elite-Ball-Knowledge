...
VIO is the synthesis of camera geometry from [59-autonomy-computer-vision.md](59-autonomy-computer-vision.md) and the estimation theory of [53-autonomy-state-estimation-advanced.md](53-autonomy-state-estimation-advanced.md) and [52-autonomy-sensor-fusion.md](52-autonomy-sensor-fusion.md). It is the front-end of the SLAM systems in [51-autonomy-slam-and-mapping.md](51-autonomy-slam-and-mapping.md), provides the navigation state for the GNC of [28-autonomy-gnc.md](28-autonomy-gnc.md), and is the GPS-denied fallback that makes the resilience of [26-autonomy-gnss-jamming-spoofing.md](26-autonomy-gnss-jamming-spoofing.md) real. The optimization math is nonlinear least squares from [03-foundations-mathematics.md](03-foundations-mathematics.md); deployment onboard draws on [64-autonomy-edge-inference-deployment.md](64-autonomy-edge-inference-deployment.md) and the PX4/SITL toolchain of [22-autonomy-px4-sitl.md](22-autonomy-px4-sitl.md).
...
- Deploys onboard via the techniques of [64-autonomy-edge-inference-deployment.md](64-autonomy-edge-inference-deployment.md), feeding pose to PX4/ROS 2.
