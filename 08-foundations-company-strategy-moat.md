...
[07-foundations-defense-acquisition.md](07-foundations-defense-acquisition.md). Throughout, we
...
integration.** See also [05_distributed_systems_comms_mesh.md](05_distributed_systems_comms_mesh.md)
...
[07-foundations-defense-acquisition.md](07-foundations-defense-acquisition.md) §11 for the
mechanics.)
...
profile, see [27-autonomy-counter-uas-ew.md](27-autonomy-counter-uas-ew.md)) is answered with a
...
problem in [05_distributed_systems_comms_mesh.md](05_distributed_systems_comms_mesh.md)), that
...
that makes this work under DDIL links is [05_distributed_systems_comms_mesh.md](05_distributed_systems_comms_mesh.md).)
...
[11-career-defense-aerospace-playbook.md](11-career-defense-aerospace-playbook.md)): it
...
- [07-foundations-defense-acquisition.md](07-foundations-defense-acquisition.md) — the contracting
...
- [09-foundations-safety-assurance.md](09-foundations-safety-assurance.md) — the safety case that
  *is* the assurance moat.
- [05_distributed_systems_comms_mesh.md](05_distributed_systems_comms_mesh.md) — the engineering
