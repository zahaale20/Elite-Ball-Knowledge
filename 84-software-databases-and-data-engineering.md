...
[20-autonomy-ml-ai.md](20-autonomy-ml-ai.md), the storage engine that the distributed-systems
guarantees of [80-software-distributed-systems-deep.md](80-software-distributed-systems-deep.md)
replicate and partition, and the source of training data for
[85-software-mlops-and-ml-infrastructure.md](85-software-mlops-and-ml-infrastructure.md). It rides
the transports of [83-software-networking-and-protocols.md](83-software-networking-and-protocols.md),
must be hardened per [86-software-cybersecurity-engineering.md](86-software-cybersecurity-engineering.md)
and encrypted per [87-software-cryptography-applied.md](87-software-cryptography-applied.md),
follows the engineering discipline of [12-career-software-engineering.md](12-career-software-engineering.md),
and powers the OSINT/sensemaking work of [35-osint-verification-and-sensemaking.md](35-osint-verification-and-sensemaking.md)
and the vertical-integration data strategy of [41-companies-tesla-vertical-integration-data.md](41-companies-tesla-vertical-integration-data.md).
...
- **Data quality & lineage:** tests, schemas (great_expectations), and lineage tracking so a bad
  ...
  the verification discipline in [06-foundations-simulation-test-verification.md](06-foundations-simulation-test-verification.md).
...
([85-software-mlops-and-ml-infrastructure.md](85-software-mlops-and-ml-infrastructure.md)) →
