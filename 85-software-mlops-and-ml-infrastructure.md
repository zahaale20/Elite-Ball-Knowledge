...
This module operationalizes the learning algorithms of [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md),
serves models on the GPUs of [81-software-gpu-and-parallel-computing.md](81-software-gpu-and-parallel-computing.md),
draws its training data from the pipelines of [84-software-databases-and-data-engineering.md](84-software-databases-and-data-engineering.md),
runs on the distributed infrastructure of [80-software-distributed-systems-deep.md](80-software-distributed-systems-deep.md),
and must meet the latency budgets of [82-software-real-time-operating-systems.md](82-software-real-time-operating-systems.md)
on the embedded edge. It inherits the safety burden of [09-foundations-safety-assurance.md](09-foundations-safety-assurance.md),
the security concerns of [86-software-cybersecurity-engineering.md](86-software-cybersecurity-engineering.md),
the engineering practice of [12-career-software-engineering.md](12-career-software-engineering.md),
and embodies the data-as-moat strategy of [41-companies-tesla-vertical-integration-data.md](41-companies-tesla-vertical-integration-data.md)
and [39-companies-anduril-productized-defense.md](39-companies-anduril-productized-defense.md).
...
- **Distributed training:** data/model/pipeline parallelism over many GPUs with all-reduce
  ([81-software-gpu-and-parallel-computing.md](81-software-gpu-and-parallel-computing.md)),
...
[09-foundations-safety-assurance.md](09-foundations-safety-assurance.md). In a defense context,
...
- **Optimization:** quantization (FP32 → INT8), pruning, distillation, and graph compilation
  ...
  [81-software-gpu-and-parallel-computing.md](81-software-gpu-and-parallel-computing.md) and the
  thermal budget of [72-engineering-thermal-management.md](72-engineering-thermal-management.md).
- **Serving topology:** *cloud serving* (high throughput, batched, behind an autoscaling API) vs
  *edge serving* (on-vehicle, single-stream, hard real-time, disconnected). Autonomy lives mostly
  at the edge, where the [82-software-real-time-operating-systems.md](82-software-real-time-operating-systems.md)
...
to [41-companies-tesla-vertical-integration-data.md](41-companies-tesla-vertical-integration-data.md)
and [39-companies-anduril-productized-defense.md](39-companies-anduril-productized-defense.md) — is
