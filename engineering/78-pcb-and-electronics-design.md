...
and the motor drivers of [73-engineering-mechatronics-and-actuation.md](73-mechatronics-and-actuation.md).
It is constrained by the power budget of [79-engineering-batteries-and-energy-storage.md](79-batteries-and-energy-storage.md),
the manufacturability rules of [75-engineering-manufacturing-and-dfm.md](75-manufacturing-and-dfm.md)
...
([76](76-systems-engineering-mbse.md)), the physical realization of a set of
...
an intermittent, maddening field failure ([77](77-reliability-and-failure-analysis.md)).
...
- **Keep the motor/power section physically separated** from the MCU and sensors (the
  magnetometer especially — §4 of [74](74-sensors-and-instrumentation.md)).
...
Keeping $T_j$ low is direct reliability (Arrhenius, [77](77-reliability-and-failure-analysis.md)).

**DFM for boards** (the [75](75-manufacturing-and-dfm.md) mindset applied to
...
([76](76-systems-engineering-mbse.md)) and the test discipline of
[06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md):
