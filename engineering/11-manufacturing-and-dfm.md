...
Manufacturing turns the mechanical design of [04-career-mechanical-engineering.md](../career/04-mechanical-engineering.md)
...
It is coupled to the actuator housings of [09-engineering-mechatronics-and-actuation.md](09-mechatronics-and-actuation.md),
...
sensors that verify parts come from [10-engineering-sensors-and-instrumentation.md](10-sensors-and-instrumentation.md).
...
3. **Eliminate fasteners** where possible — snap fits, press fits beat screws (screws are
   slow and loosen, see vibration in [13](13-reliability-and-failure-analysis.md)).
...
V-model ([12-engineering-systems-engineering-mbse.md](12-systems-engineering-mbse.md)),
