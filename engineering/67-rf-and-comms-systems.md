...
This is the direct bridge to [26-autonomy-gnss-jamming-spoofing.md](../autonomy/26-gnss-jamming-spoofing.md): a jammer's job is to overcome your processing gain with raw power; the **jam-to-signal ratio** the receiver tolerates is the design battleground.
