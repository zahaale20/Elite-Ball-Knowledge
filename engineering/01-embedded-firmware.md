...
Embedded firmware is where the abstractions of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md) meet copper and silicon. The C++ discipline of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) governs how you write deterministic, allocation-free code here; the safety arguments of [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md) are what force you to prove your watchdog actually resets a hung MCU. The mechanical realities of [04-career-mechanical-engineering.md](../career/04-mechanical-engineering.md) explain why your IMU mounting matters, and the linear-algebra and numerical-stability material in [03-foundations-mathematics.md](../foundations/03-mathematics.md) is what your fixed-point filters depend on. This module is the foundation of the "Engineering Across Domains" band; it pairs tightly with [02-engineering-fpga-and-hardware-accel.md](02-fpga-and-hardware-accel.md) (when firmware isn't fast enough), [04-engineering-power-electronics.md](04-power-electronics.md) (what your gate-drive firmware commands), and [08-engineering-thermal-management.md](08-thermal-management.md) (why your MCU throttles).
...
3. **Beware priority inversion.** A low-priority task holding a resource a high-priority task needs is a real-time killer; see [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md).
...
The decisive concept for both is the **real-time guarantee**. A hard-real-time loop must close within its deadline *every* cycle, not on average. You prove this by bounding worst-case execution time (WCET) and worst-case interrupt latency. Tools: cycle counters (`DWT->CYCCNT`), a scope on a GPIO toggled at loop start/end (the cheapest, most honest timing tool ever), and static analysis. This is the same WCET discipline demanded in [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md).
