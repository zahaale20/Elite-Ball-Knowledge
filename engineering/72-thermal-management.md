...
1. **Reduce the heat** — efficiency first (a 95% converter dumps a third the heat of an 85% one). The cheapest watt to cool is the one never generated, tying thermal directly to [68-engineering-power-electronics.md](68-power-electronics.md).
