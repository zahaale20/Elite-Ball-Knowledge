...
Energy storage powers the actuators of [73-engineering-mechatronics-and-actuation.md](73-mechatronics-and-actuation.md)
...
It is the endurance driver in the VTOL roadmap of [21-autonomy-vtol-roadmap.md](../autonomy/21-vtol-roadmap.md)
...
Pack manufacturing follows [75-engineering-manufacturing-and-dfm.md](75-manufacturing-and-dfm.md),
...
and the board PDN of [78-engineering-pcb-and-electronics-design.md](78-pcb-and-electronics-design.md) —
...
- **Cell matching:** parallel cells share current; mismatched internal resistance causes uneven
  ...
  the whole pack (the series-reliability tyranny of [77](77-reliability-and-failure-analysis.md)).
...
- **Mechanical:** cells need compression (pouch), vibration isolation, and crash protection — a
  structural and DFM problem ([75](75-manufacturing-and-dfm.md)).
...
| **Communication** | report to the vehicle (CAN, the ICD of [76](76-systems-engineering-mbse.md)) |
...
[52-autonomy-sensor-fusion.md](../autonomy/52-sensor-fusion.md) applied to a battery: a
...
- **Prevention:** BMS limits (voltage, current, temperature window), quality cells (screen
  infant mortality, [77](77-reliability-and-failure-analysis.md)), mechanical
...
- **Heat is the enemy** — every cycle at high temperature accelerates capacity fade (Arrhenius
  again, [77](77-reliability-and-failure-analysis.md)).
