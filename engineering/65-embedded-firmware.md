...
Embedded firmware is where the abstractions of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md) meet copper and silicon. The C++ discipline of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) governs how you write deterministic, allocation-free code here; the safety arguments of [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md) are what force you to prove your watchdog actually resets a hung MCU. The mechanical realities of [13-career-mechanical-engineering.md](../career/13-mechanical-engineering.md) explain why your IMU mounting matters, and the linear-algebra and numerical-stability material in [03-foundations-mathematics.md](../foundations/03-mathematics.md) is what your fixed-point filters depend on. This module is the foundation of the "Engineering Across Domains" band; it pairs tightly with [66-engineering-fpga-and-hardware-accel.md](66-fpga-and-hardware-accel.md) (when firmware isn't fast enough), [68-engineering-power-electronics.md](68-power-electronics.md) (what your gate-drive firmware commands), and [72-engineering-thermal-management.md](72-thermal-management.md) (why your MCU throttles).
