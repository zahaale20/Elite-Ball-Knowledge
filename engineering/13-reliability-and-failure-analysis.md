...
[09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md): a safety case is
only as credible as its failure-rate evidence. It draws on the probability of
[03-foundations-mathematics.md](../foundations/03-mathematics.md), constrains the
architecture and redundancy of [12-engineering-systems-engineering-mbse.md](12-systems-engineering-mbse.md),
and is fed by the manufacturing variation of [11-engineering-manufacturing-and-dfm.md](11-manufacturing-and-dfm.md).
It governs the drivetrains of [09-engineering-mechatronics-and-actuation.md](09-mechatronics-and-actuation.md),
the boards of [14-engineering-pcb-and-electronics-design.md](14-pcb-and-electronics-design.md),
and the packs of [15-engineering-batteries-and-energy-storage.md](15-batteries-and-energy-storage.md).
Sensor drift over life ([10-engineering-sensors-and-instrumentation.md](10-sensors-and-instrumentation.md))
is a reliability problem, and every reliability claim is demonstrated through the test
regime of [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md).
...
case of [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md) and the
fault trees of §5.
...
[09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md) and the
distributed-systems redundancy of [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md).
...
- **SAE ARP4761 — *Guidelines for Conducting Safety Assessment*.** FTA/FMEA for aerospace, pairing with [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md).
