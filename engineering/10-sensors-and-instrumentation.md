...
[13-autonomy-sensor-fusion.md](../autonomy/13-sensor-fusion.md) and the state estimators of
[14-autonomy-state-estimation-advanced.md](../autonomy/14-state-estimation-advanced.md),
...
Signal conditioning lives on the board of [14-engineering-pcb-and-electronics-design.md](14-pcb-and-electronics-design.md);
...
core argument of [13-autonomy-sensor-fusion.md](../autonomy/13-sensor-fusion.md).
...
[07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md). GNSS is
...
| Encoder (optical) | codewheel | angle (see §6 of [09](09-mechatronics-and-actuation.md)) | dust |
...
fuses modalities ([11-autonomy-perception-deep.md](../autonomy/11-perception-deep.md),
[13-autonomy-sensor-fusion.md](../autonomy/13-sensor-fusion.md)).
...
loop costs phase margin (see [06-autonomy-control-theory.md](../autonomy/06-control-theory.md)).
...
- **Online estimation:** carry sensor biases as states in the EKF
  ([13-autonomy-sensor-fusion.md](../autonomy/13-sensor-fusion.md)) so they are tracked in
