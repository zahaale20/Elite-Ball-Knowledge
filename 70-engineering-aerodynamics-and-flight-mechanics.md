...
Aerodynamics is fluid mechanics and calculus made physical — the differential equations of [03-foundations-mathematics.md](03-foundations-mathematics.md) governing pressure, velocity, and circulation. The stability and control half feeds directly into the control theory of [25-autonomy-control-theory.md](25-autonomy-control-theory.md) and the GNC of [28-autonomy-gnc.md](28-autonomy-gnc.md): the stability derivatives derived here *are* the plant model those controllers stabilize. Propulsion ([69-engineering-propulsion-and-electric-propulsion.md](69-engineering-propulsion-and-electric-propulsion.md)) provides the thrust that aerodynamics turns into motion; structures ([71-engineering-structures-and-materials.md](71-engineering-structures-and-materials.md)) carry the aerodynamic loads; and the whole vehicle is a balance of forces in the first-principles tradition of [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md).
...
A positive static margin means that if the nose pitches up (α increases), a restoring nose-down moment develops. Too much margin makes the aircraft sluggish; too little (or negative) makes it twitchy or divergent. Modern fighters are deliberately *unstable* (negative margin) for agility, relying on the flight computer to stabilize them at high rate — the ultimate expression of control compensating for aerodynamics, and a direct hand-off to [25-autonomy-control-theory.md](25-autonomy-control-theory.md).
...
These derivatives come from analysis (vortex-lattice, CFD), wind tunnels, or flight-test system identification. They are precisely the plant model the GNC stack of [28-autonomy-gnc.md](28-autonomy-gnc.md) needs — aerodynamics hands control engineering a matrix it can design against.
