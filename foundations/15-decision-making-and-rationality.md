...
in [10-autonomy-planning-decision.md](../autonomy/10-planning-decision.md), uses the formal tools of
[02-probability-and-stochastic.md](../mathematics/02-probability-and-stochastic.md),
[12-applied-statistics-and-causal-inference.md](12-applied-statistics-and-causal-inference.md), and
[11-decision-and-game-theory.md](../mathematics/11-decision-and-game-theory.md), and is the
cognitive counterpart to the manipulation-defense in
[01-psychological-manipulation-defense.md](../mindset-and-society/01-psychological-manipulation-defense.md)
...
- **Utility is nonlinear in money/stakes.** Losing your entire runway is far more than twice as bad
  ...
  utility, [13](13-economics-and-markets.md)). So maximize expected *utility*, not raw expected
...
| **Sunk-cost fallacy** | Continue because of past investment | Only future marginal cost/benefit matters ([13](13-economics-and-markets.md)) |
...
| **Survivorship bias** | Only seeing winners | Ask where the failures are ([12](12-applied-statistics-and-causal-inference.md)) |
...
Beyond the formula ([117 §7](12-applied-statistics-and-causal-inference.md)), Bayesian thinking is a
...
This is the same machinery your EKF runs ([09](../autonomy/09-gnc.md)): prior, measurement, weighted
...
- **Second-order thinking.** Always ask "and then what?" The first-order effect is obvious; the
  cascade is where the real consequences (and the mistakes) live ([19](19-systems-thinking-and-complexity.md)).
...
- **Opportunity-cost check** — for any yes, name what you're saying no to ([13](13-economics-and-markets.md)).
...
- **Cap the downside first.** The precondition for taking many convex bets is surviving each one
  (§8, §2). This is why the financial buffer in [14](14-personal-finance-and-the-math-of-wealth.md)
...
This is the formal backbone of [11-startup-asymmetric-playbook.md](../companies/11-startup-asymmetric-playbook.md)
...
- **Groupthink.** The desire for harmony suppresses dissent; the group converges prematurely on a bad
  ...
  memos, [08](../companies/08-amazon-mechanisms-customer-obsession.md)), and have the **most senior
...
**Cross-links**
- Formal probability and Bayes: [02](../mathematics/02-probability-and-stochastic.md),
  [12](12-applied-statistics-and-causal-inference.md).
- Strategic/multi-agent decisions: [11-decision-and-game-theory.md](../mathematics/11-decision-and-game-theory.md).
- Defending against others exploiting these biases: [01-psychological-manipulation-defense.md](../mindset-and-society/01-psychological-manipulation-defense.md),
  [03-cognitive-bias-attention-and-narratives.md](../information-environment/03-cognitive-bias-attention-and-narratives.md).
- Asymmetric bets in practice: [11-startup-asymmetric-playbook.md](../companies/11-startup-asymmetric-playbook.md).
