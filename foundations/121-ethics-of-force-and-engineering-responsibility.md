...
([29](../autonomy/29-planning-decision.md), and the constitution-gated policy in the author's
`drone/` `policy/` modules). It connects to
[14-career-dod-politics.md](../career/14-dod-politics.md) and
[112-politics-navigation.md](../mindset-and-society/112-politics-navigation.md) for the institutional
dimension.
...
2. **Proportionality** — the expected civilian harm of an attack must not be excessive relative to
   ...
   ([120](120-decision-making-and-rationality.md)) baked into engagement logic.
...
distributional-shift ways [20](../autonomy/20-ml-ai.md) and [62](../autonomy/62-sim-to-real.md)
...
- **Be truthful and objective in public and professional statements.** Don't let the program's need
  for good news corrupt your reporting of risk ([116 §7](116-writing-and-technical-communication.md)).
...
destroyed — [112-politics-navigation.md](../mindset-and-society/112-politics-navigation.md) and
...
- **Second- and third-order effects dominate** ([124](124-systems-thinking-and-complexity.md)). The
...
see [111](../mindset-and-society/111-psychological-manipulation-defense.md)).
...
- **Distinguish discomfort from violation.** Not every uncomfortable assignment is unethical; reserve
  ...
  else in [120](120-decision-making-and-rationality.md).
...
you're relying on to stay ethical (motivated reasoning, [120](120-decision-making-and-rationality.md)).
...
| **Outcome rationalization** | "It worked out, so it was fine" | Judge the decision, not the luck ([120](120-decision-making-and-rationality.md)) |
...
- Mission/legal context: [07-foundations-defense-acquisition.md](07-defense-acquisition.md),
  [14-career-dod-politics.md](../career/14-dod-politics.md).
- The autonomy decision stack being constrained: [29-autonomy-planning-decision.md](../autonomy/29-planning-decision.md).
- Conformity/authority pressures on courage: [111-psychological-manipulation-defense.md](../mindset-and-society/111-psychological-manipulation-defense.md).
- Reasoning under uncertainty: [120-decision-making-and-rationality.md](120-decision-making-and-rationality.md).
