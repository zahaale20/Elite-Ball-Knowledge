...
[118-economics-and-markets.md](118-economics-and-markets.md) (time value, opportunity cost, risk) to
*your own* balance sheet; it uses the probabilistic/EV reasoning of
[120-decision-making-and-rationality.md](120-decision-making-and-rationality.md); and it connects to
[15-career-negotiation-compensation.md](../career/15-negotiation-compensation.md) (the income side)
and [122-negotiation-and-persuasion.md](122-negotiation-and-persuasion.md).
...
2. **Runway** — enough saved that you could take a pay cut, switch fields, or join a startup without
   ...
   ([47](../companies/47-startup-asymmetric-playbook.md)) the rest of this repo encourages.
...
- **Frame startup equity correctly: it is a lottery ticket with positive expected value but a fat
  ...
  truly afford the bet and believe in the asymmetric upside ([120](120-decision-making-and-rationality.md),
  [47](../companies/47-startup-asymmetric-playbook.md)), and (b) never let illiquid paper equity
...
This connects directly to [15-career-negotiation-compensation.md](../career/15-negotiation-compensation.md)
...
**Cross-links**
- Economic primitives (time value, risk, opportunity cost): [118-economics-and-markets.md](118-economics-and-markets.md).
- Expected value and asymmetric bets: [120-decision-making-and-rationality.md](120-decision-making-and-rationality.md).
- The income side (negotiating comp/equity): [15-career-negotiation-compensation.md](../career/15-negotiation-compensation.md)
  and [122-negotiation-and-persuasion.md](122-negotiation-and-persuasion.md).
