...
> **Why this file exists.** The probability module ([96](../mathematics/96-probability-and-stochastic.md))
...
**Companion practice.** This module deepens [96-probability-and-stochastic.md](../mathematics/96-probability-and-stochastic.md)
...
[41-tesla-vertical-integration-data.md](../companies/41-tesla-vertical-integration-data.md). The
...
[28-autonomy-gnc.md](../autonomy/28-gnc.md) — a Kalman filter *is* recursive Bayesian estimation.
...
**Cross-links**
- Formal probability: [96-probability-and-stochastic.md](../mathematics/96-probability-and-stochastic.md).
- Recursive Bayesian estimation in practice (the EKF): [28-autonomy-gnc.md](../autonomy/28-gnc.md).
- Bias–variance and overfitting in ML: [20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md).
- Using these tools for decisions: [120-decision-making-and-rationality.md](120-decision-making-and-rationality.md).
