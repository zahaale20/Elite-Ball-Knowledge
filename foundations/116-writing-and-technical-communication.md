...
career-facing presentation guides ([17](../career/17-interview-prep.md),
[18](../career/18-resume-portfolio.md)). Where those teach what to say, this teaches how to make it
land.
...
6. **Alternatives considered, and why rejected** — this is what separates a real design doc from a
   ...
   reasoning from [120-decision-making-and-rationality.md](120-decision-making-and-rationality.md).)
...
- **Frame around the reader's goals, not your enthusiasm.** "This will let the program hit its
  ...
  function (see [118-economics-and-markets.md](118-economics-and-markets.md) on incentives).
...
- **Quantify uncertainty instead of hiding it.** "~70% confident we hit the date; the schedule risk
  ...
  [120-decision-making-and-rationality.md](120-decision-making-and-rationality.md).)
...
- **Apply the Feynman test from [115](115-learning-how-to-learn.md):** explain a hard concept in
...
*Cross-links: pairs with [33-cognitive-bias-attention-and-narratives.md](../information-environment/33-cognitive-bias-attention-and-narratives.md)
(communicating under uncertainty), [120-decision-making-and-rationality.md](120-decision-making-and-rationality.md)
(reasoning you're making legible), and the career presentation guides ([17](../career/17-interview-prep.md),
[18](../career/18-resume-portfolio.md)).*
