...
This deep dive closes the core of the band under [37-companies-how-the-giants-win.md](37-companies-how-the-giants-win.md). Its integration story pairs with SpaceX and Tesla ([38](38-companies-spacex-rapid-iteration.md), [41](41-companies-tesla-vertical-integration-data.md)); its ecosystem/platform dimension with Nvidia ([42-companies-nvidia-platform-ecosystem.md](42-companies-nvidia-platform-ecosystem.md)); its focus/leadership themes with [19-career-leadership-growth.md](19-career-leadership-growth.md); and its design-as-systems-thinking with [01_first_principles_systems_engineering.md](01_first_principles_systems_engineering.md).
...
The decision rule is the same as SpaceX and Tesla ([38](38-companies-spacex-rapid-iteration.md), [41](41-companies-tesla-vertical-integration-data.md)): **own the components that are (a) strategic to the experience, (b) a source of differentiation, or (c) a competitive bottleneck — buy the rest.**
...
- **Resources are finite; greatness requires concentration.** Spreading effort across many products yields many mediocre ones. Concentrating yields a few great ones. This is the inverse of feature-checklist thinking that plagues defense procurement (see [07-foundations-defense-acquisition.md](07-foundations-defense-acquisition.md)).
...
- **Subtraction is harder than addition.** Adding feels productive; cutting feels like loss. Most people and orgs are addition-biased — which is precisely why disciplined subtraction is rare and valuable. (Compare "delete the part" in SpaceX's Algorithm, [38](38-companies-spacex-rapid-iteration.md).)
...
- Ecosystem effects (iMessage, AirPods/Continuity, App Store, iCloud) raise switching costs the way Nvidia's CUDA does ([42](42-companies-nvidia-platform-ecosystem.md)) — once you're in the Apple world, leaving means losing the coherence.
