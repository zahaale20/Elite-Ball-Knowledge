...
probability of [96-foundations-probability-and-stochastic.md](96-foundations-probability-and-stochastic.md)
and the general math of [03-foundations-mathematics.md](03-foundations-mathematics.md); its
divergences are minimized by [95-foundations-optimization.md](95-foundations-optimization.md);
its channels are sampled and filtered per
[99-foundations-signal-processing.md](99-foundations-signal-processing.md). It quantifies what
sensors deliver in [28-autonomy-gnc.md](28-autonomy-gnc.md), defines the loss functions of
[20-autonomy-ml-ai.md](20-autonomy-ml-ai.md), informs the value-of-information in
[29-autonomy-planning-decision.md](29-autonomy-planning-decision.md), and bounds the links that
control loops in [25-autonomy-control-theory.md](25-autonomy-control-theory.md) depend on.
...
- **Cross-entropy loss** decomposes as $H(p,q) = H(p) + D_{\mathrm{KL}}(p\|q)$; since $H(p)$ is
  ...
  cross-entropy (see [20-autonomy-ml-ai.md](20-autonomy-ml-ai.md)).
