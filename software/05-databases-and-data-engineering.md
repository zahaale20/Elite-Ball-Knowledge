...
[01-autonomy-ml-ai.md](../autonomy/01-ml-ai.md), the storage engine that the distributed-systems
guarantees of [01-software-distributed-systems-deep.md](01-distributed-systems-deep.md)
replicate and partition, and the source of training data for
[06-software-mlops-and-ml-infrastructure.md](06-mlops-and-ml-infrastructure.md). It rides
the transports of [04-software-networking-and-protocols.md](04-networking-and-protocols.md),
must be hardened per [07-software-cybersecurity-engineering.md](07-cybersecurity-engineering.md)
and encrypted per [08-software-cryptography-applied.md](08-cryptography-applied.md),
follows the engineering discipline of [03-career-software-engineering.md](../career/03-software-engineering.md),
and powers the OSINT/sensemaking work of [05-osint-verification-and-sensemaking.md](../information-environment/05-osint-verification-and-sensemaking.md)
and the vertical-integration data strategy of [05-companies-tesla-vertical-integration-data.md](../companies/05-tesla-vertical-integration-data.md).
...
[01-software-distributed-systems-deep.md](01-distributed-systems-deep.md).
...
([06-software-mlops-and-ml-infrastructure.md](06-mlops-and-ml-infrastructure.md)) →
