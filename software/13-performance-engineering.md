...
Performance engineering is where the compiler knowledge of [12-software-compilers-and-languages.md](12-compilers-and-languages.md) and the real-time discipline of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) become quantitative. It is the production-time complement to the observability of [09-software-observability-and-sre.md](09-observability-and-sre.md) — the same "measure, don't guess" ethic applied to a single process rather than a fleet. The systems decomposition of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md) tells you *which* performance matters, and the verification rigor of [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md) keeps your benchmarks honest. This module sits at the heart of the "Software, Compute & Infrastructure" band and pairs with [11-software-systems-programming-rust.md](11-systems-programming-rust.md) (zero-cost abstractions), [25-autonomy-edge-inference-deployment.md](../autonomy/25-edge-inference-deployment.md) (squeezing models onto edge hardware), and [10-software-cloud-and-kubernetes.md](10-cloud-and-kubernetes.md) (why a service is slow at scale).
...
The synergy of this module: SoA layout (Section 3) makes data packed and independent → the optimizer (Section on the compiler, [12-software-compilers-and-languages.md](12-compilers-and-languages.md)) auto-vectorizes it → SIMD gives 8× → and you *verified* it in the profiler. Each layer enables the next.
...
For systems serving requests, **Little's Law** (from [09-software-observability-and-sre.md](09-observability-and-sre.md)) is the performance-capacity bridge:
...
The professional standard: benchmarks live in CI and a regression that slows a hot path by >X% fails the build, exactly as a correctness test would (the CI rigor of [15-software-testing-and-verification-deep.md](15-testing-and-verification-deep.md)). Performance, once won, must be *defended* — it silently rots otherwise.
