...
[05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md), the transport
beneath the distributed agreement of [01-software-distributed-systems-deep.md](01-distributed-systems-deep.md),
and the link whose jitter the real-time loops of [03-software-real-time-operating-systems.md](03-real-time-operating-systems.md)
and [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) must tolerate.
It connects to the GNSS/jamming reality of [07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md)
and the EW threat of [08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md), the security
hardening of [07-software-cybersecurity-engineering.md](07-cybersecurity-engineering.md)
and [06-trust-safety-opsec-and-digital-resilience.md](../information-environment/06-trust-safety-opsec-and-digital-resilience.md),
the crypto that secures it in [08-software-cryptography-applied.md](08-cryptography-applied.md),
and the engineering practice of [03-career-software-engineering.md](../career/03-software-engineering.md).
...
- **Jamming resilience:** frequency hopping, spread spectrum, and directional antennas
  ([08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md)); the software must tolerate the
...
[01-software-distributed-systems-deep.md](01-distributed-systems-deep.md) and the safety
cases of [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md).
