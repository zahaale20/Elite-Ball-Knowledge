...
[07-software-cybersecurity-engineering.md](07-cybersecurity-engineering.md), the
confidentiality and integrity layer over the networks of
[04-software-networking-and-protocols.md](04-networking-and-protocols.md), and the trust
that the distributed systems of [01-software-distributed-systems-deep.md](01-distributed-systems-deep.md)
and the data stores of [05-software-databases-and-data-engineering.md](05-databases-and-data-engineering.md)
depend on. It underpins the OPSEC and resilience of [06-trust-safety-opsec-and-digital-resilience.md](../information-environment/06-trust-safety-opsec-and-digital-resilience.md),
secures the model supply chain of [06-software-mlops-and-ml-infrastructure.md](06-mlops-and-ml-infrastructure.md),
relates to the GNSS authentication problem of [07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md),
and applies the rigor of [03-career-software-engineering.md](../career/03-software-engineering.md)
...
([07-software-cybersecurity-engineering.md](07-cybersecurity-engineering.md)).
