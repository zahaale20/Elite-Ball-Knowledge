...
[05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md), the durable store
behind the world model in [01-autonomy-ml-ai.md](../autonomy/01-ml-ai.md), and the reliability
floor that the real-time code of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md)
runs on once it leaves a single box. It connects to the networking physics of
[04-software-networking-and-protocols.md](04-networking-and-protocols.md), the storage
internals of [05-software-databases-and-data-engineering.md](05-databases-and-data-engineering.md),
the engineering practice of [03-career-software-engineering.md](../career/03-software-engineering.md),
and the adversarial threat models of [06-trust-safety-opsec-and-digital-resilience.md](../information-environment/06-trust-safety-opsec-and-digital-resilience.md)
and [07-software-cybersecurity-engineering.md](07-cybersecurity-engineering.md). The
GPU and RTOS siblings ([02-software-gpu-and-parallel-computing.md](02-gpu-and-parallel-computing.md),
[03-software-real-time-operating-systems.md](03-real-time-operating-systems.md)) handle
...
- **Jepsen analyses (jepsen.io).** Empirical consistency testing of real databases — humbling
  and educational, and a model for [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md).
