...
[01-software-distributed-systems-deep.md](01-distributed-systems-deep.md), the links of
[04-software-networking-and-protocols.md](04-networking-and-protocols.md), the data of
[05-software-databases-and-data-engineering.md](05-databases-and-data-engineering.md),
and the models of [06-software-mlops-and-ml-infrastructure.md](06-mlops-and-ml-infrastructure.md).
It rests on the cryptography of [08-software-cryptography-applied.md](08-cryptography-applied.md),
extends the operational digital-resilience and OPSEC of [06-trust-safety-opsec-and-digital-resilience.md](../information-environment/06-trust-safety-opsec-and-digital-resilience.md),
connects to the EW/jamming threat of [08-autonomy-counter-uas-ew.md](../autonomy/08-counter-uas-ew.md)
and [07-autonomy-gnss-jamming-spoofing.md](../autonomy/07-gnss-jamming-spoofing.md), shares the
memory-safety concerns of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md),
the engineering rigor of [03-career-software-engineering.md](../career/03-software-engineering.md),
and the assurance mindset of [09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md).
...
In C and C++ — the languages of flight software ([04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md))
...
- **Mutual TLS (mTLS):** both sides present certificates, so a node proves its identity, not just
  ...
  ([08-software-cryptography-applied.md](08-cryptography-applied.md)).
...
- **Segmentation:** put the flight-critical bus, the mission computer, and the management plane on
  ...
  the partitioning of [03-software-real-time-operating-systems.md](03-real-time-operating-systems.md)).
...
([09-foundations-safety-assurance.md](../foundations/09-safety-assurance.md)) and distributed-failure
([01-software-distributed-systems-deep.md](01-distributed-systems-deep.md)) modules:
