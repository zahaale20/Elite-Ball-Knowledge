...
This module powers the perception and learning of [01-autonomy-ml-ai.md](../autonomy/01-ml-ai.md),
feeds the ML-serving infrastructure of [06-software-mlops-and-ml-infrastructure.md](06-mlops-and-ml-infrastructure.md),
and complements the low-latency CPU real-time work of
[04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) and
[03-software-real-time-operating-systems.md](03-real-time-operating-systems.md). It is
...
shares the software-engineering discipline of [03-career-software-engineering.md](../career/03-software-engineering.md),
and the platform-ecosystem strategy of [06-companies-nvidia-platform-ecosystem.md](../companies/06-nvidia-platform-ecosystem.md)
...
- **Sort:** radix sort on GPU is bandwidth-bound and extremely fast; underpins spatial hashing
  for [12-autonomy-slam-and-mapping.md](../autonomy/12-slam-and-mapping.md)-style nearest-neighbor.
...
distributed-systems concerns of [01-software-distributed-systems-deep.md](01-distributed-systems-deep.md)
return:
...
and thermal** budget ([08-engineering-thermal-management.md](../engineering/08-thermal-management.md)),
