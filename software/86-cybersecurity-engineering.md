...
[80-software-distributed-systems-deep.md](80-distributed-systems-deep.md), the links of
[83-software-networking-and-protocols.md](83-networking-and-protocols.md), the data of
[84-software-databases-and-data-engineering.md](84-databases-and-data-engineering.md),
and the models of [85-software-mlops-and-ml-infrastructure.md](85-mlops-and-ml-infrastructure.md).
It rests on the cryptography of [87-software-cryptography-applied.md](87-cryptography-applied.md),
extends the operational digital-resilience and OPSEC of [36-trust-safety-opsec-and-digital-resilience.md](../information-environment/36-trust-safety-opsec-and-digital-resilience.md),
connects to the EW/jamming threat of [27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md)
and [26-autonomy-gnss-jamming-spoofing.md](../autonomy/26-gnss-jamming-spoofing.md), shares the
memory-safety concerns of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md),
the engineering rigor of [12-career-software-engineering.md](../career/12-software-engineering.md),
...
- **Mutual TLS (mTLS):** both sides present certificates, so a node proves its identity, not just
  ...
  ([87-software-cryptography-applied.md](87-cryptography-applied.md)).
...
- **Segmentation:** put the flight-critical bus, the mission computer, and the management plane on
  ...
  the partitioning of [82-software-real-time-operating-systems.md](82-real-time-operating-systems.md)).
...
([80-software-distributed-systems-deep.md](80-distributed-systems-deep.md)) modules:
