...
behind the world model in [20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md), and the reliability
...
[83-software-networking-and-protocols.md](83-networking-and-protocols.md), the storage
internals of [84-software-databases-and-data-engineering.md](84-databases-and-data-engineering.md),
the engineering practice of [12-career-software-engineering.md](../career/12-software-engineering.md),
and the adversarial threat models of [36-trust-safety-opsec-and-digital-resilience.md](../information-environment/36-trust-safety-opsec-and-digital-resilience.md)
and [86-software-cybersecurity-engineering.md](86-cybersecurity-engineering.md). The
GPU and RTOS siblings ([81-software-gpu-and-parallel-computing.md](81-gpu-and-parallel-computing.md),
[82-software-real-time-operating-systems.md](82-real-time-operating-systems.md)) handle
