...
A syntactically valid program can still be nonsense: `"hello" * 3.0`, calling an undeclared function, using a moved value (the Rust borrow check of [90-software-systems-programming-rust.md](90-systems-programming-rust.md)). **Semantic analysis** walks the AST and checks meaning:
...
- **Performance reasoning** — when you understand inlining and vectorization you write code the optimizer can actually accelerate, and you read the emitted assembly (via `godbolt.org`, the Compiler Explorer) to confirm it (the core method of [92-software-performance-engineering.md](92-performance-engineering.md)).
