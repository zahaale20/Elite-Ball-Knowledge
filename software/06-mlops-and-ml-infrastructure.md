...
This module operationalizes the learning algorithms of [01-autonomy-ml-ai.md](../autonomy/01-ml-ai.md),
serves models on the GPUs of [02-software-gpu-and-parallel-computing.md](02-gpu-and-parallel-computing.md),
draws its training data from the pipelines of [05-software-databases-and-data-engineering.md](05-databases-and-data-engineering.md),
runs on the distributed infrastructure of [01-software-distributed-systems-deep.md](01-distributed-systems-deep.md),
and must meet the latency budgets of [03-software-real-time-operating-systems.md](03-real-time-operating-systems.md)
...
the security concerns of [07-software-cybersecurity-engineering.md](07-cybersecurity-engineering.md),
the engineering practice of [03-career-software-engineering.md](../career/03-software-engineering.md),
and embodies the data-as-moat strategy of [05-companies-tesla-vertical-integration-data.md](../companies/05-tesla-vertical-integration-data.md)
and [03-productized-defense.md](../companies/03-productized-defense.md).
...
- **Distributed training:** data/model/pipeline parallelism over many GPUs with all-reduce
  ([02-software-gpu-and-parallel-computing.md](02-gpu-and-parallel-computing.md)),
...
- **Optimization:** quantization (FP32 → INT8), pruning, distillation, and graph compilation
  ...
  [02-software-gpu-and-parallel-computing.md](02-gpu-and-parallel-computing.md) and the
  thermal budget of [08-engineering-thermal-management.md](../engineering/08-thermal-management.md).
- **Serving topology:** *cloud serving* (high throughput, batched, behind an autoscaling API) vs
  *edge serving* (on-vehicle, single-stream, hard real-time, disconnected). Autonomy lives mostly
  at the edge, where the [03-software-real-time-operating-systems.md](03-real-time-operating-systems.md)
...
to [05-companies-tesla-vertical-integration-data.md](../companies/05-tesla-vertical-integration-data.md)
and [03-productized-defense.md](../companies/03-productized-defense.md) — is
