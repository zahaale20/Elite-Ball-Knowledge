...
Performance engineering is where the compiler knowledge of [91-software-compilers-and-languages.md](91-compilers-and-languages.md) and the real-time discipline of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) become quantitative. It is the production-time complement to the observability of [88-software-observability-and-sre.md](88-observability-and-sre.md) — the same "measure, don't guess" ethic applied to a single process rather than a fleet. The systems decomposition of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md) tells you *which* performance matters, and the verification rigor of [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md) keeps your benchmarks honest. This module sits at the heart of the "Software, Compute & Infrastructure" band and pairs with [90-software-systems-programming-rust.md](90-systems-programming-rust.md) (zero-cost abstractions), [64-autonomy-edge-inference-deployment.md](../autonomy/64-edge-inference-deployment.md) (squeezing models onto edge hardware), and [89-software-cloud-and-kubernetes.md](89-cloud-and-kubernetes.md) (why a service is slow at scale).
...
The synergy of this module: SoA layout (Section 3) makes data packed and independent → the optimizer (Section on the compiler, [91-software-compilers-and-languages.md](91-compilers-and-languages.md)) auto-vectorizes it → SIMD gives 8× → and you *verified* it in the profiler. Each layer enables the next.
...
For systems serving requests, **Little's Law** (from [88-software-observability-and-sre.md](88-observability-and-sre.md)) is the performance-capacity bridge:
...
The professional standard: benchmarks live in CI and a regression that slows a hot path by >X% fails the build, exactly as a correctness test would (the CI rigor of [94-software-testing-and-verification-deep.md](94-testing-and-verification-deep.md)). Performance, once won, must be *defended* — it silently rots otherwise.
