...
This module powers the perception and learning of [20-autonomy-ml-ai.md](../autonomy/20-ml-ai.md),
feeds the ML-serving infrastructure of [85-software-mlops-and-ml-infrastructure.md](85-mlops-and-ml-infrastructure.md),
...
[82-software-real-time-operating-systems.md](82-real-time-operating-systems.md). It is
...
shares the software-engineering discipline of [12-career-software-engineering.md](../career/12-software-engineering.md),
and the platform-ecosystem strategy of [42-companies-nvidia-platform-ecosystem.md](../companies/42-nvidia-platform-ecosystem.md)
...
- **Sort:** radix sort on GPU is bandwidth-bound and extremely fast; underpins spatial hashing
  for [51-autonomy-slam-and-mapping.md](../autonomy/51-slam-and-mapping.md)-style nearest-neighbor.
...
distributed-systems concerns of [80-software-distributed-systems-deep.md](80-distributed-systems-deep.md)
return:
...
and thermal** budget ([72-engineering-thermal-management.md](../engineering/72-thermal-management.md)),
