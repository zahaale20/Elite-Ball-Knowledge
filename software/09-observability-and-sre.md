...
Observability is where the systems-thinking of [01_first_principles_systems_engineering.md](../foundations/01-first_principles_systems_engineering.md) becomes a daily operational reality, and where the test-and-verification mindset of [06-foundations-simulation-test-verification.md](../foundations/06-simulation-test-verification.md) extends from pre-flight into production. The career framing of [03-career-software-engineering.md](../career/03-software-engineering.md) explains why SRE roles command leverage; the real-time discipline of [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) is what your latency budgets are spent on. This module opens the back half of the "Software, Compute & Infrastructure" band and pairs tightly with [10-software-cloud-and-kubernetes.md](10-cloud-and-kubernetes.md) (where your services run), [13-software-performance-engineering.md](13-performance-engineering.md) (why a latency SLO is violated), [14-software-api-and-system-design.md](14-api-and-system-design.md) (what you are observing), and [15-software-testing-and-verification-deep.md](15-testing-and-verification-deep.md) (the pre-production half of the same loop). It builds on the distributed-systems foundations in [05_distributed_systems_comms_mesh.md](../foundations/05-distributed_systems_comms_mesh.md).
...
Autoscaling (covered operationally in [10-software-cloud-and-kubernetes.md](10-cloud-and-kubernetes.md)) handles short-term elasticity, but it is not a substitute for capacity planning: scaling has a lag, and you cannot autoscale past a quota or a downstream bottleneck you forgot to provision.
