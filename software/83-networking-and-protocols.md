...
beneath the distributed agreement of [80-software-distributed-systems-deep.md](80-distributed-systems-deep.md),
and the link whose jitter the real-time loops of [82-software-real-time-operating-systems.md](82-real-time-operating-systems.md)
and [04-foundations-modern-cpp-realtime.md](../foundations/04-modern-cpp-realtime.md) must tolerate.
It connects to the GNSS/jamming reality of [26-autonomy-gnss-jamming-spoofing.md](../autonomy/26-gnss-jamming-spoofing.md)
and the EW threat of [27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md), the security
hardening of [86-software-cybersecurity-engineering.md](86-cybersecurity-engineering.md)
and [36-trust-safety-opsec-and-digital-resilience.md](../information-environment/36-trust-safety-opsec-and-digital-resilience.md),
the crypto that secures it in [87-software-cryptography-applied.md](87-cryptography-applied.md),
and the engineering practice of [12-career-software-engineering.md](../career/12-software-engineering.md).
...
- **Jamming resilience:** frequency hopping, spread spectrum, and directional antennas
  ([27-autonomy-counter-uas-ew.md](../autonomy/27-counter-uas-ew.md)); the software must tolerate the
...
[80-software-distributed-systems-deep.md](80-distributed-systems-deep.md) and the safety
